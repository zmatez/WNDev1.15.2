...
public class weeping_cedar_1 extends SchemFeature {
    public weeping_cedar_1() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(-2, 2, 0, "minecraft:oak_leaves[distance=4,persistent=true]");
        ...
        Block(0, 11, 2, "minecraft:oak_leaves[distance=2,persistent=true]");
        Block(0, 7, 3, "minecraft:oak_leaves[distance=3,persistent=true]");
        Block(0, 8, 3, "minecraft:oak_leaves[distance=3,persistent=true]");
