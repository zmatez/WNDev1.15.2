...
public class WNColdSilverlands extends WNBiome {
    public WNColdSilverlands(String name) {
        ...
        WNBiomeFeatures.addPlant(this, WNBlocks.SNOWDROP.getDefaultState().with(FloweringBushBase.FLOWERING, true), 2);
