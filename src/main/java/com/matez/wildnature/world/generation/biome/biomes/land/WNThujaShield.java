...
import com.matez.wildnature.world.generation.structures.nature.woods.spruce.spruce1;
import com.matez.wildnature.world.generation.structures.nature.woods.spruce.spruce2;
import com.matez.wildnature.world.generation.structures.nature.woods.spruce.spruce3;
import com.matez.wildnature.world.generation.structures.nature.woods.spruce.spruce4;
...
public class WNThujaShield extends WNBiome {
    public WNThujaShield(String name) {
        super(name, (new WNBiomeBuilder())
                .surfaceBuilder(WNSurfaceBuilders.CUSTOM_SURFACE_BUILDER, new CustomSurfaceBuilderConfig(new CustomSurfaceBuilder.BlockCfg(WNSurfaceBuilders.BROWN_CONFIG, 3), new CustomSurfaceBuilder.BlockCfg(WNSurfaceBuilders.BROWN_PODZOL_CONFIG, 1)))
                ...
                .logTypes(LogType.PINE,LogType.LARCH,LogType.BEECH,LogType.OAK,LogType.SMALL_BIRCH,LogType.SMALL_OAK,LogType.BIRCH,LogType.SPRUCE,LogType.ROWAN)
                .parent(null));
