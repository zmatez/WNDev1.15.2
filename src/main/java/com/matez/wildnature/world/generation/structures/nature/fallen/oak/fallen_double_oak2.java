...
public class fallen_double_oak2 extends FallenSchemFeature {

    @Override
    public Set<BlockPos> setBlocks() {

        Block(0, 0, -5, "minecraft:oak_log[axis=y]");
        Block(-1, 0, -4, "minecraft:oak_log[axis=y]");
        Block(0, 0, -4, "minecraft:oak_log[axis=y]");
        Block(1, 0, -4, "minecraft:oak_log[axis=y]");
        Block(1, 1, -4, "minecraft:oak_log[axis=y]");
        ...
        Block(1, 1, 3, "minecraft:oak_leaves[distance=2,persistent=true]");
        Block(-1, 2, 3, "minecraft:oak_leaves[distance=3,persistent=true]");
        Block(1, 2, 3, "minecraft:oak_leaves[distance=3,persistent=true]");
        Block(-1, 1, 4, "minecraft:oak_leaves[distance=3,persistent=true]");
