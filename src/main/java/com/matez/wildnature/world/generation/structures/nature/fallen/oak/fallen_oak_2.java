...
public class fallen_oak_2 extends FallenSchemFeature {
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(-3, 1, -3, "minecraft:oak_leaves[distance=4,persistent=true]");
        ...
        Block(-4, 1, -2, "minecraft:oak_leaves[distance=4,persistent=true]");
        ...
        Block(0, 2, 0, "minecraft:oak_leaves[distance=2,persistent=true]");
