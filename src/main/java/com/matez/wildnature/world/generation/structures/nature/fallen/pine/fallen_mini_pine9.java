...
public class fallen_mini_pine9 extends FallenSchemFeature {
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(0, 0, -5, "minecraft:spruce_log[axis=y]");
        ...
        Block(1, 1, -2, "minecraft:spruce_leaves[distance=1,persistent=true]");
        Block(2, 1, -2, "minecraft:spruce_leaves[distance=2,persistent=true]");
        ...
        Block(1, 2, -2, "minecraft:spruce_leaves[distance=2,persistent=true]");
        Block(2, 2, -2, "minecraft:vine[east=false,north=false,south=false,up=false,west=true]");
        Block(-2, 1, -1, "minecraft:spruce_leaves[distance=2,persistent=true]");
        ...
        Block(1, 2, 5, "minecraft:spruce_leaves[distance=2,persistent=true]");
        Block(0, 1, 6, "minecraft:spruce_leaves[distance=1,persistent=true]");
        Block(1, 1, 6, "minecraft:spruce_leaves[distance=2,persistent=true]");
        Block(-1, 2, 6, "minecraft:vine[east=true,north=false,south=false,up=false,west=false]");
        Block(0, 2, 6, "minecraft:spruce_leaves[distance=2,persistent=true]");
        Block(1, 2, 6, "minecraft:vine[east=false,north=true,south=false,up=false,west=false]");
        Block(0, 1, 7, "minecraft:spruce_leaves[distance=2,persistent=true]");
