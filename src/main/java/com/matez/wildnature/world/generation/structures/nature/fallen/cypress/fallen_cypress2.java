...
public class fallen_cypress2 extends FallenSchemFeature {

    @Override
    public Set<BlockPos> setBlocks() {

        Block(0, 0, -6, "wildnature:redwood_log[axis=y]");
        ...
        Block(1, 2, 1, "minecraft:spruce_leaves[distance=2,persistent=true]");
        Block(2, 2, 1, "minecraft:vine[east=false,north=false,south=false,up=false,west=true]");
        Block(0, 0, 2, "minecraft:vine[east=false,north=false,south=false,up=true,west=false]");
