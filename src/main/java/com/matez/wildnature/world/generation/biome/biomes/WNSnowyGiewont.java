...
import com.matez.wildnature.world.generation.structures.nature.woods.mini_pine.mini_bald_pine1;
import com.matez.wildnature.world.generation.structures.nature.woods.mini_pine.mini_bald_pine2;
...
public class WNSnowyGiewont extends WNBiome {
    public WNSnowyGiewont(String name) {
        super(name, (new WNBiomeBuilder())
                .surfaceBuilder(WNSurfaceBuilders.GIEWONT_SURFACE_BUILDER, WNSurfaceBuilders.OVERGROWN_STONE_CONFIG)
