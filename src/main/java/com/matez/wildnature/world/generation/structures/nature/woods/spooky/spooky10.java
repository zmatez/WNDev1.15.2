...
public class spooky10 extends SchemFeature {
    public spooky10() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(-1, 4, -2, "minecraft:dark_oak_leaves[distance=3,persistent=true]");
        ...
        Block(-1, 1, 0, "wildnature:lightning_bug[facing=west]");
        ...
        Block(2, 3, 0, "wildnature:lightning_bug[facing=north]");
        ...
        Block(2, 4, 4, "minecraft:dark_oak_leaves[distance=4,persistent=true]");
