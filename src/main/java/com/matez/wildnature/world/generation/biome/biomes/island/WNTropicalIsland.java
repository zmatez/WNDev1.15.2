...
public class WNTropicalIsland extends WNBiome {
    public WNTropicalIsland(String name) {
        ...
        WNBiomeFeatures.addTree(this, new tree_palm12().setCustomLog(WN.getBlockByID("wildnature:palm_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:palm_leaves"))), 2);
