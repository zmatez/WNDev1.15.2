...
public class WNDeadDesolation extends WNBiome {
    public WNDeadDesolation(String name) {
        super(name, (new WNBiomeBuilder())
                .surfaceBuilder(WNSurfaceBuilders.DEAD_SURFACE_BUILDER, WNSurfaceBuilders.DESERT_CONFIG)
        ...
        WNBiomeFeatures.addPlant(this, WN.getBlockByID("minecraft:grass").getDefaultState(), 2);
        WNBiomeFeatures.addPlant(this, WN.getBlockByID("wildnature:small_cacti").getDefaultState(), 1);
        WNBiomeFeatures.addPlant(this, WN.getBlockByID("wildnature:desert_grass").getDefaultState(), 1);
        WNBiomeFeatures.addPlant(this, WN.getBlockByID("minecraft:dead_short_grass").getDefaultState(), 5);
