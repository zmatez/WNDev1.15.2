...
import com.matez.wildnature.world.generation.feature.features.*;
...
public class WNFeatures {
    ...
    private static Feature<?>[] features = new Feature<?>[]{
            ...
            GEM_FORMATION_FEATURE = new GemFormationFeature(BlockVeinFeatureConfig::deserialize),
    ...
    public static void registerAll(final RegistryEvent.Register<Feature<?>> event) {
        ...
        WN.LOGGER.info("Registered " + (regExit-regEntry) + " features.");
    }
}
