...
public class fallen_mini_pine8 extends FallenSchemFeature {

    @Override
    public Set<BlockPos> setBlocks() {

        Block(0, 0, -7, "wildnature:pine_log[axis=y]");
        ...
        Block(0, 1, 4, "wildnature:pine_leaves[distance=1,persistent=true]");
