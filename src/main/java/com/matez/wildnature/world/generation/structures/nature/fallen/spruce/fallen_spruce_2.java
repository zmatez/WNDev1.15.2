package com.matez.wildnature.world.generation.structures.nature.fallen.spruce;
...
public class fallen_spruce_2 extends FallenSchemFeature {
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(3, 1, -6, "minecraft:spruce_leaves[distance=7,persistent=true]");
        Block(4, 1, -6, "minecraft:vine[east=false,north=false,south=false,up=false,west=true]");
        Block(2, 1, -5, "minecraft:spruce_leaves[distance=3,persistent=true]");
        Block(3, 1, -5, "minecraft:vine[east=false,north=true,south=false,up=false,west=true]");
        Block(1, 1, -4, "minecraft:spruce_leaves[distance=1,persistent=true]");
        Block(2, 1, -4, "minecraft:spruce_leaves[distance=2,persistent=true]");
        ...
        Block(3, 1, -3, "minecraft:spruce_leaves[distance=2,persistent=true]");
        Block(1, 2, -3, "minecraft:spruce_leaves[distance=1,persistent=true]");
        Block(2, 2, -3, "minecraft:spruce_leaves[distance=2,persistent=true]");
        ...
        Block(0, 2, 1, "minecraft:spruce_leaves[distance=2,persistent=true]");
        ...
        Block(-1, 0, 4, "minecraft:spruce_log[axis=y]");
