...
public class fallen_acacia_2 extends FallenSchemFeature {
...
Block(0,1,-3,"minecraft:acacia_leaves[distance=4,persistent=true]");
...
Block(-2,2,0,"minecraft:acacia_leaves[distance=2,persistent=true]");
