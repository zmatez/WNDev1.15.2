...
public class fallen_mini_pine7 extends FallenSchemFeature {
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(1, 1, -4, "minecraft:spruce_leaves[distance=1,persistent=true]");
        Block(-2, 1, -3, "minecraft:spruce_leaves[distance=2,persistent=true]");
        ...
        Block(1, 2, 4, "minecraft:spruce_leaves[distance=2,persistent=true]");
        ...
        Block(1, 1, 5, "minecraft:spruce_leaves[distance=2,persistent=true]");
        Block(0, 2, 5, "minecraft:vine[east=false,north=true,south=false,up=false,west=false]");
        Block(0, 1, 6, "minecraft:spruce_leaves[distance=2,persistent=true]");
