...
public class WNPrehistoricValley extends WNBiome {
    public WNPrehistoricValley(String name) {
        super(name, (new WNBiomeBuilder())
                .surfaceBuilder(WNSurfaceBuilders.NOISE_SURFACE_BUILDER, new Noise2SurfaceBuilderConfig(SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG, new SurfaceBuilderConfig(Blocks.COARSE_DIRT.getDefaultState(), Blocks.GRAVEL.getDefaultState(), Blocks.DIRT.getDefaultState())))
