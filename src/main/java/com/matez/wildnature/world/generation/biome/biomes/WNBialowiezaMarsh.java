...
public class WNBialowiezaMarsh extends WNBiome {
    public WNBialowiezaMarsh(String name) {
        ...
        WNBiomeFeatures.addTree(this, new tree_willow9().setCustomLog(WN.getBlockByID("wildnature:willow_log").getDefaultState()).setCustomLeaf(tree_birch1.notDecayingLeaf(WN.getBlockByID("wildnature:willow_leaves"))), 1);
        WNBiomeFeatures.addTree(this, new tree_willow10().setCustomLog(WN.getBlockByID("wildnature:willow_log").getDefaultState()).setCustomLeaf(tree_birch1.notDecayingLeaf(WN.getBlockByID("wildnature:willow_leaves"))), 1);
