...
public class WNAutumnalPoplarForest extends WNBiome {
    public WNAutumnalPoplarForest(String name) {
        super(name, (new WNBiomeBuilder())
                ...
                .logTypes(LogType.POPLAR, LogType.BEECH, LogType.FORSYTHIA, LogType.ROWAN, LogType.PINE)
                .parent(null));
