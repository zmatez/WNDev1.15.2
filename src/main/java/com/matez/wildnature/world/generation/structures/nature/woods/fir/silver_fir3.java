...
public class silver_fir3 extends SchemFeature {
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(2, 3, 0, "wildnature:fir_silver_leaves[distance=7,persistent=true,stage=0]");
        ...
        Block(2, 2, 1, "wildnature:fir_silver_leaves[distance=7,persistent=true,stage=0]");
        Block(0, 5, 1, "wildnature:fir_silver_leaves[distance=1,persistent=true,stage=0]");
