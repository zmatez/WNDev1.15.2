...
public class WNIcelands extends WNBiome {
    public WNIcelands(String name) {
        super(name, (new WNBiomeBuilder())
                .surfaceBuilder(WNSurfaceBuilders.GRAND_CANYON_SURFACE_BUILDER, new CanyonSurfaceBuilderConfig(Blocks.SNOW_BLOCK.getDefaultState(), Blocks.PACKED_ICE.getDefaultState(), Blocks.GRAVEL.getDefaultState(), WNSurfaceBuilders.ICELANDS_SURFACE_BUILDER))
