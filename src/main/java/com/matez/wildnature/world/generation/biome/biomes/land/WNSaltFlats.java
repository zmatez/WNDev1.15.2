...
public class WNSaltFlats extends WNBiome {
    public WNSaltFlats(String name) {
        super(name, (new WNBiomeBuilder())
                .surfaceBuilder(SurfaceBuilder.DEFAULT, new SurfaceBuilderConfig(WN.getBlockByID("wildnature:salt_block").getDefaultState(), WN.getBlockByID("wildnature:salt_block").getDefaultState(), WN.getBlockByID("minecraft:gravel").getDefaultState()))
