...
public class WNSafariHills extends WNBiome {
    public WNSafariHills(String name) {
        super(name, (new WNBiomeBuilder())
                .surfaceBuilder(WNSurfaceBuilders.NOISE_SURFACE_BUILDER, new Noise2SurfaceBuilderConfig(WNSurfaceBuilders.DESERT_CONFIG, SurfaceBuilder.SAND_SAND_GRAVEL_CONFIG))
