...
public class WNAutumnalSpruceForest extends WNBiome {
    public WNAutumnalSpruceForest(String name) {
        ...
        WNBiomeFeatures.addTree(this, new tree_fir7().setCustomLog(WN.getBlockByID("minecraft:spruce_log").getDefaultState()).setCustomLeaf(tree_birch1.notDecayingLeaf(WN.getBlockByID("wildnature:fir_leaves"))), 2);
