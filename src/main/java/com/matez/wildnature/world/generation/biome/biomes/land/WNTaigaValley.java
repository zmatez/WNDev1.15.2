...
import com.matez.wildnature.world.generation.structures.nature.woods.pine.thin_pine1;
import com.matez.wildnature.world.generation.structures.nature.woods.pine.thin_pine2;
import com.matez.wildnature.world.generation.structures.nature.woods.pine.thin_pine3;
import com.matez.wildnature.world.generation.structures.nature.woods.pine.thin_pine4;
...
public class WNTaigaValley extends WNBiome {
    public WNTaigaValley(String name) {
        ...
        WNBiomeFeatures.addTree(this, new tree_spruce_m1().setCustomLog(WN.getBlockByID("wildnature:pine_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:pine_leaves"))), 3);
        WNBiomeFeatures.addTree(this, new tree_spruce_m2().setCustomLog(WN.getBlockByID("wildnature:pine_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:pine_leaves"))), 3);
        WNBiomeFeatures.addTree(this, new tree_spruce_m3().setCustomLog(WN.getBlockByID("wildnature:pine_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:pine_leaves"))), 3);
        WNBiomeFeatures.addTree(this, new tree_spruce_m4().setCustomLog(WN.getBlockByID("wildnature:pine_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:pine_leaves"))), 3);
        WNBiomeFeatures.addTree(this, new tree_spruce_m5().setCustomLog(WN.getBlockByID("wildnature:pine_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:pine_leaves"))), 3);
        WNBiomeFeatures.addTree(this, new tree_spruce_m6().setCustomLog(WN.getBlockByID("wildnature:pine_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:pine_leaves"))), 3);
        WNBiomeFeatures.addTree(this, new tree_spruce_m7().setCustomLog(WN.getBlockByID("wildnature:pine_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:pine_leaves"))), 3);
        WNBiomeFeatures.addTree(this, new tree_spruce_m8().setCustomLog(WN.getBlockByID("wildnature:pine_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:pine_leaves"))), 3);
        WNBiomeFeatures.addTree(this, new tree_spruce_m9().setCustomLog(WN.getBlockByID("wildnature:pine_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:pine_leaves"))), 3);

        WNBiomeFeatures.addTree(this, new tree_taiga11().setCustomLog(WN.getBlockByID("minecraft:spruce_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("minecraft:spruce_leaves"))), 7);
        WNBiomeFeatures.addTree(this, new tree_taiga12().setCustomLog(WN.getBlockByID("minecraft:spruce_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("minecraft:spruce_leaves"))), 7);
