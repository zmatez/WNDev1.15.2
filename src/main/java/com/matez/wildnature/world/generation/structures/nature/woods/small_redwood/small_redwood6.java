...
public class small_redwood6 extends SchemFeature {
    public small_redwood6() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(-1, 1, -2, "wildnature:redwood_log[axis=y]");
        Block(-1, 11, -2, "wildnature:redwood_leaves[distance=3,persistent=true]");
        Block(0, 11, -2, "wildnature:redwood_leaves[distance=3,persistent=true]");
        Block(1, 11, -2, "wildnature:redwood_leaves[distance=3,persistent=true]");
        ...
        Block(0, 11, -1, "wildnature:redwood_branch[down=true,east=true,north=true,south=true,up=true,waterlogged=false,west=true]");
        Block(1, 11, -1, "wildnature:redwood_leaves[distance=2,persistent=true]");
        ...
        Block(1, 12, -1, "wildnature:redwood_leaves[distance=2,persistent=true]");
        Block(0, 13, -1, "wildnature:redwood_leaves[distance=2,persistent=true]");
        ...
        Block(0, 13, 0, "wildnature:redwood_leaves[distance=1,persistent=true]");
        Block(1, 13, 0, "wildnature:redwood_leaves[distance=2,persistent=true]");
        Block(0, 14, 0, "wildnature:redwood_leaves[distance=2,persistent=true]");
        Block(0, 15, 0, "wildnature:redwood_leaves[distance=3,persistent=true]");
        Block(-1, 1, 1, "wildnature:redwood_log[axis=y]");
        Block(0, 1, 1, "wildnature:redwood_log[axis=y]");
        Block(0, 2, 1, "wildnature:redwood_log[axis=y]");
        Block(0, 3, 1, "wildnature:redwood_log[axis=y]");
        ...
        Block(0, 13, 1, "wildnature:redwood_leaves[distance=2,persistent=true]");
        Block(1, 1, 2, "wildnature:redwood_log[axis=y]");
        Block(-1, 8, 2, "wildnature:redwood_leaves[distance=3,persistent=true]");
        Block(0, 8, 2, "wildnature:redwood_leaves[distance=3,persistent=true]");
        Block(1, 8, 2, "wildnature:redwood_leaves[distance=2,persistent=true]");
