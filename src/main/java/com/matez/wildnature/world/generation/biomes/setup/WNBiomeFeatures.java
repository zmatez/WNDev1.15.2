...
import com.matez.wildnature.world.generation.structures.nature.woods.fallen.*;
...
public class WNBiomeFeatures extends DefaultBiomeFeatures {
    ...
    public static void addCrystals(Biome biomeIn) {
        if(biomeIn!= com.matez.wildnature.world.generation.biomes.setup.WNBiomes.Polders)
