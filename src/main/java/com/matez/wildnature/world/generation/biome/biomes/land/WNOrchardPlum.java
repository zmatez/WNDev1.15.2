...
public class WNOrchardPlum extends WNBiome {
    public WNOrchardPlum(String name) {
        ...
        WNBiomeFeatures.addTree(this, new tree_oak5().setCustomLog(WN.getBlockByID("minecraft:oak_log").getDefaultState()).setCustomLeaf(tree_birch1.notDecayingLeaf(WNBlocks.PLUM_LEAVES)), 4);
        WNBiomeFeatures.addTree(this, new tree_oak5().setCustomLog(WN.getBlockByID("minecraft:oak_log").getDefaultState()).setCustomLeaf(tree_birch1.notDecayingLeaf(Blocks.OAK_LEAVES)), 4);
