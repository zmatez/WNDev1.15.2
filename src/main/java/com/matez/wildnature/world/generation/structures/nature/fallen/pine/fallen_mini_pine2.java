...
public class fallen_mini_pine2 extends FallenSchemFeature {
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(1, 1, -1, "wildnature:pine_leaves[distance=1,persistent=true]");
        Block(0, 2, -1, "wildnature:pine_leaves[distance=2,persistent=true]");
        Block(1, 2, -1, "minecraft:vine[east=false,north=false,south=false,up=false,west=true]");
        Block(-3, 0, 0, "wildnature:pine_log[axis=y]");
        Block(-3, 1, 0, "wildnature:pine_log[axis=y]");
        Block(-1, 1, 0, "wildnature:pine_log[axis=x]");
        Block(0, 1, 0, "wildnature:pine_log[axis=x]");
        Block(1, 1, 0, "wildnature:pine_log[axis=x]");
        Block(2, 1, 0, "wildnature:pine_leaves[distance=1,persistent=true]");
        ...
        Block(0, 1, 2, "minecraft:vine[east=false,north=true,south=false,up=false,west=false]");
