...
public class fallen_forsythia_3 extends FallenSchemFeature {


    @Override
    public Set<BlockPos> setBlocks() {

        Block(0, 1, -3, "wildnature:forsythia_leaves[distance=4,flowering=true,persistent=true]");
        ...
        Block(-5, 0, -1, "wildnature:rosaceae_branch[down=true,east=false,north=false,south=true,up=false,waterlogged=false,west=false]");
        ...
        Block(3, 1, -1, "wildnature:forsythia_leaves[distance=5,flowering=true,persistent=true]");
        ...
        Block(-5, 1, 0, "wildnature:rosaceae_branch[down=true,east=true,north=false,south=false,up=false,waterlogged=false,west=false]");
        ...
        Block(-2, 2, 0, "wildnature:rosaceae_branch[down=true,east=true,north=false,south=false,up=false,waterlogged=false,west=false]");
        ...
        Block(2, 2, 0, "wildnature:forsythia_leaves[distance=4,flowering=true,persistent=true]");
        Block(0, 3, 0, "wildnature:forsythia_leaves[distance=3,flowering=true,persistent=true]");
        ...
        Block(1, 2, 1, "wildnature:forsythia_leaves[distance=4,flowering=true,persistent=true]");
        Block(-1, 1, 2, "wildnature:forsythia_leaves[distance=4,flowering=true,persistent=true]");
        Block(0, 1, 2, "wildnature:forsythia_leaves[distance=5,flowering=true,persistent=true]");
        Block(1, 1, 2, "wildnature:forsythia_leaves[distance=4,flowering=true,persistent=true]");
        Block(2, 1, 2, "wildnature:forsythia_leaves[distance=5,flowering=true,persistent=true]");
        Block(-1, 2, 2, "wildnature:forsythia_leaves[distance=3,flowering=true,persistent=true]");
        Block(0, 2, 2, "wildnature:forsythia_leaves[distance=4,flowering=true,persistent=true]");
        Block(-1, 1, 3, "wildnature:forsythia_leaves[distance=5,flowering=true,persistent=true]");
        Block(0, 1, 3, "wildnature:forsythia_leaves[distance=6,flowering=true,persistent=true]");
        Block(1, 1, 3, "wildnature:forsythia_leaves[distance=5,flowering=true,persistent=true]");
