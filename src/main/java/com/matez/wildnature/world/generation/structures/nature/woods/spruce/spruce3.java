package com.matez.wildnature.world.generation.structures.nature.woods.spruce;
...
public class spruce3 extends SchemFeature {
    public spruce3() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(1, 3, 0, "minecraft:spruce_log[axis=x]");
        ...
        Block(1, 11, 0, "minecraft:spruce_leaves[distance=1,persistent=true]");
        Block(0, 12, 0, "minecraft:spruce_leaves[distance=1,persistent=true]");
