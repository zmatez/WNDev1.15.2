...
public class WNGrandCanyon extends WNBiome {
    public WNGrandCanyon(String name) {
        super(name, (new WNBiomeBuilder())
                .surfaceBuilder(WNSurfaceBuilders.GRAND_CANYON_SURFACE_BUILDER, new CanyonSurfaceBuilderConfig(SurfaceBuilder.RED_SAND_WHITE_TERRACOTTA_GRAVEL_CONFIG, SurfaceBuilder.BADLANDS))
