...
import com.matez.wildnature.common.blocks.FireWeedBush;
...
import com.matez.wildnature.world.generation.structures.nature.woods.mini_pine.mini_bald_pine3;
...
public class WNSnowyTatraFireweedValley extends WNBiome {
    public WNSnowyTatraFireweedValley(String name) {
        super(name, (new WNBiomeBuilder())
                ...
                .logTypes(LogType.SPRUCE,LogType.SMALL_PINE)
                .parent(null));
