...
import com.matez.wildnature.world.generation.structures.nature.woods.beech.thick_beech1;
import com.matez.wildnature.world.generation.structures.nature.woods.beech.thick_beech2;
import com.matez.wildnature.world.generation.structures.nature.woods.beech.thick_beech3;
import com.matez.wildnature.world.generation.structures.nature.woods.beech.thick_beech4;
...
public class WNBerryTaiga extends WNBiome {
    public WNBerryTaiga(String name) {
        super(name, (new WNBiomeBuilder())
                .surfaceBuilder(WNSurfaceBuilders.CUSTOM_SURFACE_BUILDER, new CustomSurfaceBuilderConfig(new CustomSurfaceBuilder.BlockCfg(WNSurfaceBuilders.BROWN_CONFIG, 5), new CustomSurfaceBuilder.BlockCfg(WNSurfaceBuilders.BROWN_PODZOL_CONFIG, 1)))
