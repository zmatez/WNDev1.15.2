...
public class WNOvergrownCliffs extends WNBiome {
    public WNOvergrownCliffs(String name) {
        ...
        WNBiomeFeatures.addGrass(this, 7, WN.getBlockByID("wildnature:small_grass").getDefaultState());
        WNBiomeFeatures.addGrass(this, 7, WN.getBlockByID("wildnature:medium_grass").getDefaultState());
