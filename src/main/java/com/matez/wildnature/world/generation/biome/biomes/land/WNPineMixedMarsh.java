...
import com.matez.wildnature.world.generation.structures.nature.woods.beech.weeping_beech_1;
import com.matez.wildnature.world.generation.structures.nature.woods.beech.weeping_beech_2;
import com.matez.wildnature.world.generation.structures.nature.woods.beech.weeping_beech_3;
import com.matez.wildnature.world.generation.structures.nature.woods.beech.weeping_beech_4;
...
public class WNPineMixedMarsh extends WNBiome {
    public WNPineMixedMarsh(String name) {
        super(name, (new WNBiomeBuilder())
                ...
                .logTypes(LogType.PINE,LogType.LARCH,LogType.SMALL_BIRCH,LogType.OAK,LogType.ROWAN,LogType.BEECH)
                .parent(null));
