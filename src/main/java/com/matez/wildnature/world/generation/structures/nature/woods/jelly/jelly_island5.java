...
public class jelly_island5 extends SchemFeature {
...
Block(-2,7,-4,"minecraft:smooth_sandstone");
Block(-1,7,-4,"minecraft:dirt");
Block(-3,8,-4,"minecraft:smooth_sandstone");
Block(-2,8,-4,"minecraft:sand");
Block(-1,8,-4,"minecraft:sand");
Block(0,8,-4,"minecraft:coarse_dirt");
Block(-2,9,-4,"minecraft:smooth_sandstone");
Block(-1,9,-4,"minecraft:sand");
Block(0,9,-4,"minecraft:sand");
Block(-2,5,-3,"minecraft:smooth_sandstone");
Block(-1,5,-3,"minecraft:dirt");
Block(-2,6,-3,"minecraft:sand");
Block(-1,6,-3,"minecraft:smooth_sandstone");
Block(-3,7,-3,"minecraft:smooth_sandstone");
...
Block(-2,4,-2,"minecraft:smooth_sandstone");
Block(-1,4,-2,"minecraft:coarse_dirt");
Block(-3,5,-2,"minecraft:smooth_sandstone");
Block(-2,5,-2,"minecraft:dirt");
Block(-1,5,-2,"minecraft:dirt");
Block(0,5,-2,"minecraft:stone");
Block(-3,6,-2,"minecraft:sand");
Block(-2,6,-2,"minecraft:dirt");
Block(-1,6,-2,"minecraft:dirt");
Block(0,6,-2,"minecraft:gravel");
Block(-4,7,-2,"minecraft:smooth_sandstone");
Block(-3,7,-2,"minecraft:sand");
Block(-2,7,-2,"minecraft:dirt");
Block(-1,7,-2,"minecraft:dirt");
Block(0,7,-2,"minecraft:dirt");
Block(1,7,-2,"minecraft:smooth_sandstone");
Block(-4,8,-2,"minecraft:sand");
...
Block(-4,9,-2,"wildnature:algae_block[snowy=false]");
...
Block(1,9,-2,"wildnature:algae_block[snowy=false]");
Block(2,9,-2,"wildnature:algae_block[snowy=false]");
Block(-1,3,-1,"minecraft:dirt");
Block(-2,4,-1,"minecraft:dirt");
Block(-1,4,-1,"minecraft:sand");
Block(0,4,-1,"minecraft:coarse_dirt");
Block(-3,5,-1,"minecraft:coarse_dirt");
Block(-2,5,-1,"minecraft:dirt");
Block(-1,5,-1,"minecraft:dirt");
Block(0,5,-1,"minecraft:smooth_sandstone");
Block(-3,6,-1,"minecraft:smooth_sandstone");
...
Block(-4,8,-1,"minecraft:smooth_sandstone");
...
Block(-2,6,0,"minecraft:smooth_sandstone");
Block(-1,6,0,"minecraft:dirt");
Block(0,6,0,"minecraft:gravel");
Block(1,6,0,"minecraft:smooth_sandstone");
Block(-4,7,0,"minecraft:coarse_dirt");
Block(-3,7,0,"minecraft:sand");
Block(-2,7,0,"minecraft:dirt");
Block(-1,7,0,"minecraft:dirt");
Block(0,7,0,"minecraft:dirt");
Block(1,7,0,"minecraft:coarse_dirt");
Block(2,7,0,"minecraft:smooth_sandstone");
Block(-4,8,0,"minecraft:dirt");
Block(-3,8,0,"minecraft:sand");
Block(-2,8,0,"minecraft:dirt");
Block(-1,8,0,"minecraft:dirt");
Block(0,8,0,"minecraft:coarse_dirt");
Block(1,8,0,"minecraft:coarse_dirt");
Block(2,8,0,"minecraft:sand");
...
Block(-2,3,1,"minecraft:smooth_sandstone");
Block(-2,4,1,"minecraft:smooth_sandstone");
Block(0,4,1,"minecraft:stone");
Block(-2,5,1,"minecraft:sand");
Block(0,5,1,"minecraft:stone");
Block(1,5,1,"minecraft:stone");
Block(-2,6,1,"minecraft:sand");
Block(-1,6,1,"minecraft:smooth_sandstone");
Block(0,6,1,"minecraft:gravel");
Block(1,6,1,"minecraft:gravel");
Block(-2,7,1,"minecraft:coarse_dirt");
Block(-1,7,1,"minecraft:dirt");
Block(0,7,1,"minecraft:dirt");
...
Block(0,9,2,"wildnature:algae_block[snowy=false]");
Block(1,9,2,"wildnature:algae_block[snowy=false]");
Block(2,9,2,"minecraft:coarse_dirt");
Block(0,6,3,"minecraft:coarse_dirt");
Block(-1,7,3,"minecraft:coarse_dirt");
Block(0,7,3,"minecraft:sand");
Block(-1,8,3,"minecraft:sand");
Block(0,8,3,"minecraft:smooth_sandstone");
Block(1,8,3,"minecraft:coarse_dirt");
