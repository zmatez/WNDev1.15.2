...
import com.matez.wildnature.world.generation.structures.nature.woods.cherry.wild_cherry2;
import com.matez.wildnature.world.generation.structures.nature.woods.cherry.wild_cherry4;
...
import com.matez.wildnature.world.generation.structures.nature.woods.larch.tree_larch4;
...
public class WNTemperatePineMixedForest extends WNBiome {
    public WNTemperatePineMixedForest(String name) {
        super(name, (new WNBiomeBuilder())
                ...
                .logTypes(LogType.PINE,LogType.SMALL_BIRCH,LogType.BIRCH,LogType.SMALL_OAK,LogType.BEECH,LogType.PEAR,LogType.APPLE,LogType.CHERRY,LogType.WILD_CHERRY)
                .parent(null));
