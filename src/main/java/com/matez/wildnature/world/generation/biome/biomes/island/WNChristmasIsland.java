...
import com.matez.wildnature.world.generation.structures.nature.woods.fir.tree_fir21;
...
public class WNChristmasIsland extends WNBiome {
    public WNChristmasIsland(String name) {
        super(name, (new WNBiomeBuilder())
                .surfaceBuilder(WNSurfaceBuilders.CHRISTMAS_SURFACE_BUILDER, SurfaceBuilder.STONE_STONE_GRAVEL_CONFIG)
