...
public class fallen_spruce_1 extends FallenSchemFeature {


    @Override
    public Set<BlockPos> setBlocks() {

Block(-2,1,-4,"minecraft:spruce_leaves[distance=7,persistent=true]");
...
Block(2,2,2,"minecraft:spruce_leaves[distance=2,persistent=true]");
