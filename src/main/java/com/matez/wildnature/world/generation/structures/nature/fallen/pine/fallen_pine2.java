...
public class fallen_pine2 extends FallenSchemFeature {
    

    @Override
    public Set<BlockPos> setBlocks() {

Block(2,0,-13,"wildnature:pine_log[axis=y]");
Block(2,1,-13,"minecraft:vine[east=false,north=false,south=true,up=false,west=false]");
Block(2,1,-12,"wildnature:pine_log[axis=z]");
...
Block(-2,1,2,"wildnature:pine_leaves[distance=2,persistent=true,stage=0]");
Block(-1,1,2,"wildnature:pine_leaves[distance=1,persistent=true,stage=0]");
Block(0,1,2,"wildnature:pine_log[axis=z]");
Block(1,1,2,"wildnature:pine_leaves[distance=1,persistent=true,stage=0]");
Block(2,1,2,"wildnature:pine_leaves[distance=2,persistent=true,stage=0]");
...
Block(-1,1,5,"wildnature:pine_leaves[distance=7,persistent=true,stage=0]");
Block(0,1,5,"minecraft:vine[east=false,north=true,south=false,up=false,west=true]");
