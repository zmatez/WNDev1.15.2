...
public class WNMasuria extends WNBiome {
    public WNMasuria(String name) {
        super(name, (new WNBiomeBuilder())
                .surfaceBuilder(WNSurfaceBuilders.RIVER_SURFACE_BUILDER, new CanyonSurfaceBuilderConfig(SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG, SurfaceBuilder.DEFAULT))
                ...
                .logTypes(LogType.BIRCH,LogType.PINE,LogType.SPRUCE,LogType.BEECH,LogType.BEECH_THICK,LogType.ASPEN,LogType.SMALL_OAK,LogType.OAK,LogType.PEAR,LogType.FORSYTHIA,LogType.MIRABELLE_PLUM,LogType.WILD_CHERRY)
                .parent(null));
        ...
        WNBiomeFeatures.addTree(this, new tree_birch10().setCustomLog(WN.getBlockByID("minecraft:birch_log").getDefaultState()).setCustomLeaf(tree_birch1.notDecayingLeaf(WN.getBlockByID("minecraft:birch_leaves"))), 4);
        WNBiomeFeatures.addTree(this, new tree_birch1().setCustomLog(WN.getBlockByID("minecraft:dark_oak_log").getDefaultState()).setCustomLeaf(tree_birch1.notDecayingLeaf(WN.getBlockByID("minecraft:oak_leaves"))), 4);
