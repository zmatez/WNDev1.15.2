...
public class RandomGenerator {
    ...
    public RandomGenerator(Classification classification, GeoGeneratorConfig config, List<GeoLayerConfig> strata, ArrayList<BlockState> tile){
    ...
    public void apply(Random random, int dx, int dy, int dz){
        ...
        while (i < dy) {
            ...
            layer = strata.get(NoiseUtil.round(index * (random.nextInt(strata.size() - 1))));
