...
public class WNColdRockyTaiga extends WNBiome {
    public WNColdRockyTaiga(String name) {
        super(name, (new WNBiomeBuilder())
                .surfaceBuilder(WNSurfaceBuilders.NOISE_SURFACE_BUILDER, new Noise2SurfaceBuilderConfig(WNSurfaceBuilders.BROWN_CONFIG, SurfaceBuilder.STONE_STONE_GRAVEL_CONFIG))
