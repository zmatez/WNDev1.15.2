...
public class forsythia4 extends SchemFeature {
    public forsythia4() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(0, 6, -3, "wildnature:forsythia_leaves[distance=4,flowering=false,persistent=true]");
        ...
        Block(4, 5, 0, "wildnature:forsythia_leaves[distance=4,flowering=false,persistent=true]");
