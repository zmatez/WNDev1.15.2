...
public class jelly5 extends FallenSchemFeature {

    @Override
    public Set<BlockPos> setBlocks() {

        Block(-4, 4, -3, "wildnature:jelly_orange_block[waterlogged=false]");
        Block(-4, 5, -3, "wildnature:jelly_orange_block[waterlogged=false]");
        Block(-2, 5, -3, "wildnature:jelly_orange_block[waterlogged=false]");
        Block(-4, 6, -3, "wildnature:jelly_orange_block[waterlogged=false]");
        ...
        Block(-4, 3, 0, "wildnature:jelly_orange_block[waterlogged=false]");
        Block(0, 3, 0, "wildnature:jelly_blue_block[waterlogged=false]");
        Block(-4, 4, 0, "wildnature:jelly_orange_block[waterlogged=false]");
        Block(0, 4, 0, "wildnature:jelly_blue_block[waterlogged=false]");
        Block(-4, 5, 0, "wildnature:jelly_orange_block[waterlogged=false]");
        ...
        Block(0, 9, 1, "wildnature:jelly_orange_block[waterlogged=false]");
        Block(1, 9, 1, "wildnature:jelly_orange_block[waterlogged=false]");
        Block(3, 2, 2, "wildnature:jelly_orange_block[waterlogged=false]");
        Block(3, 3, 2, "wildnature:jelly_orange_block[waterlogged=false]");
        Block(3, 4, 2, "wildnature:jelly_orange_block[waterlogged=false]");
        Block(-4, 5, 2, "wildnature:jelly_orange_block[waterlogged=false]");
        ...
        Block(1, 8, 2, "wildnature:jelly_orange_block[waterlogged=false]");
        Block(2, 8, 2, "wildnature:jelly_orange_block[waterlogged=false]");
        Block(-2, 2, 3, "wildnature:jelly_orange_block[waterlogged=false]");
