...
public class fallen_jungle_small3 extends FallenSchemFeature {
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(5, 1, -3, "minecraft:vine[east=false,north=false,south=true,up=false,west=true]");
        ...
        Block(6, 1, -2, "minecraft:vine[east=false,north=false,south=true,up=false,west=false]");
        Block(3, 2, -2, "minecraft:jungle_leaves[distance=2,persistent=true]");
        ...
        Block(0, 1, -1, "minecraft:jungle_log[axis=x]");
        Block(1, 1, -1, "minecraft:jungle_log[axis=x]");
        ...
        Block(0, 2, -1, "wildnature:jungle_branch[down=true,east=false,north=false,south=false,up=false,waterlogged=false,west=false]");
        Block(2, 2, -1, "wildnature:jungle_branch[down=true,east=true,north=false,south=true,up=false,waterlogged=false,west=false]");
        Block(3, 2, -1, "minecraft:jungle_leaves[distance=1,persistent=true]");
        Block(4, 2, -1, "wildnature:jungle_branch[down=true,east=true,north=true,south=false,up=false,waterlogged=false,west=true]");
        ...
        Block(4, 1, 0, "wildnature:jungle_branch[down=false,east=true,north=true,south=true,up=false,waterlogged=false,west=true]");
        ...
        Block(0, 2, 1, "wildnature:jungle_branch[down=true,east=true,north=false,south=false,up=false,waterlogged=false,west=true]");
        Block(1, 2, 1, "minecraft:jungle_leaves[distance=1,persistent=true]");
