...
public class fallen_paradise_apple_4 extends FallenSchemFeature {
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(5, 1, -2, "minecraft:oak_leaves[distance=4,persistent=true]");
        Block(-1, 2, -2, "minecraft:oak_leaves[distance=4,persistent=true]");
        Block(-4, 1, -1, "minecraft:oak_leaves[distance=7,persistent=true]");
        ...
        Block(5, 1, -1, "minecraft:oak_leaves[distance=3,persistent=true]");
        ...
        Block(-4, 1, 1, "minecraft:oak_leaves[distance=3,persistent=true]");
        ...
        Block(0, 1, 3, "minecraft:oak_log[axis=x]");
        ...
        Block(1, 1, 6, "minecraft:vine[east=true,north=true,south=true,up=false,west=false]");
        Block(2, 1, 6, "minecraft:oak_leaves[distance=7,persistent=true]");
        ...
        Block(2, 1, 7, "minecraft:vine[east=false,north=true,south=false,up=false,west=true]");
