...
public class fallen_acacia_1 extends FallenSchemFeature {
...
Block(1,1,-5,"minecraft:acacia_leaves[distance=7,persistent=true]");
Block(-2,1,-4,"minecraft:vine[east=true,north=false,south=false,up=false,west=false]");
Block(-1,1,-4,"minecraft:acacia_leaves[distance=5,persistent=true]");
Block(2,1,-4,"minecraft:acacia_leaves[distance=5,persistent=true]");
Block(-4,1,-3,"minecraft:acacia_leaves[distance=7,persistent=true]");
...
Block(1,1,-3,"minecraft:acacia_leaves[distance=3,persistent=true]");
Block(2,1,-3,"minecraft:acacia_leaves[distance=4,persistent=true]");
Block(3,1,-3,"minecraft:vine[east=false,north=false,south=true,up=false,west=false]");
Block(-3,1,-2,"minecraft:acacia_leaves[distance=5,persistent=true]");
Block(-2,1,-2,"minecraft:vine[east=true,north=false,south=true,up=false,west=true]");
...
Block(2,1,-2,"minecraft:acacia_leaves[distance=3,persistent=true]");
Block(3,1,-2,"minecraft:acacia_leaves[distance=4,persistent=true]");
...
Block(1,2,-2,"minecraft:acacia_leaves[distance=3,persistent=true]");
...
Block(3,1,-1,"minecraft:acacia_leaves[distance=3,persistent=true]");
Block(4,1,-1,"minecraft:vine[east=false,north=false,south=false,up=false,west=true]");
Block(0,2,-1,"minecraft:acacia_leaves[distance=3,persistent=true]");
Block(1,2,-1,"minecraft:acacia_leaves[distance=2,persistent=true]");
Block(2,2,-1,"minecraft:acacia_leaves[distance=3,persistent=true]");
...
Block(2,1,0,"minecraft:acacia_leaves[distance=1,persistent=true]");
Block(3,1,0,"minecraft:acacia_leaves[distance=2,persistent=true]");
...
Block(-2,1,1,"minecraft:acacia_leaves[distance=1,persistent=true]");
...
Block(-1,2,1,"minecraft:acacia_leaves[distance=1,persistent=true]");
...
Block(0,1,2,"minecraft:acacia_log[axis=x]");
