...
public class fallen_tall_birch3 extends FallenSchemFeature {
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(0, 1, 0, "minecraft:birch_leaves[distance=1,persistent=true]");
        Block(1, 1, 0, "minecraft:birch_log[axis=z]");
        Block(2, 1, 0, "minecraft:birch_leaves[distance=1,persistent=true]");
        Block(0, 2, 0, "minecraft:birch_leaves[distance=2,persistent=true]");
        ...
        Block(3, 1, 1, "minecraft:birch_leaves[distance=2,persistent=true]");
        ...
        Block(2, 1, 4, "minecraft:birch_leaves[distance=7,persistent=true]");
