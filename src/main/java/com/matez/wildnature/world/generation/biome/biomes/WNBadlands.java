...
public class WNBadlands extends WNBiome {
    public WNBadlands(String name) {
        super(name, (new WNBiomeBuilder())
                .surfaceBuilder(SurfaceBuilder.DEFAULT, new SurfaceBuilderConfig(Blocks.SANDSTONE.getDefaultState(), WN.getBlockByID("wildnature:desert_dirt").getDefaultState(), WN.getBlockByID("wildnature:desert_dirt").getDefaultState()))
