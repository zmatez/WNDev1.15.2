...
public class fallen_weeping_cedar1 extends FallenSchemFeature {
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(1, 1, -1, "minecraft:vine[east=false,north=false,south=true,up=false,west=true]");
        Block(2, 1, -1, "minecraft:oak_leaves[distance=3,persistent=true]");
        ...
        Block(1, 2, 0, "minecraft:vine[east=true,north=false,south=true,up=false,west=true]");
        Block(2, 2, 0, "minecraft:oak_leaves[distance=3,persistent=true]");
        ...
        Block(0, 1, 3, "wildnature:cedar_log[axis=z]");
        Block(1, 1, 3, "minecraft:oak_leaves[distance=1,persistent=true]");
        Block(2, 1, 3, "minecraft:oak_leaves[distance=2,persistent=true]");
        ...
        Block(1, 2, 3, "minecraft:oak_leaves[distance=2,persistent=true]");
        Block(2, 2, 3, "minecraft:vine[east=false,north=true,south=false,up=false,west=true]");
        ...
        Block(1, 1, 4, "minecraft:oak_leaves[distance=2,persistent=true]");
        Block(2, 1, 4, "minecraft:oak_leaves[distance=3,persistent=true]");
        ...
        Block(1, 1, 5, "minecraft:oak_leaves[distance=3,persistent=true]");
