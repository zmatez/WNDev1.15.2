...
public class fallen_oak_1 extends FallenSchemFeature {
...
Block(-2,1,-3,"minecraft:oak_leaves[distance=5,persistent=true]");
Block(-1,1,-3,"minecraft:oak_leaves[distance=4,persistent=true]");
Block(0,1,-3,"minecraft:oak_leaves[distance=3,persistent=true]");
Block(1,1,-3,"minecraft:oak_leaves[distance=4,persistent=true]");
Block(-1,2,-3,"minecraft:oak_leaves[distance=5,persistent=true]");
