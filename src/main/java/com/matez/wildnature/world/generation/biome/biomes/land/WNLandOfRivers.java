...
import com.matez.wildnature.world.generation.structures.nature.woods.fir.tree_fir5;
...
import com.matez.wildnature.world.generation.structures.nature.woods.spruce.tree_taiga10;
...
public class WNLandOfRivers extends WNBiome {
    public WNLandOfRivers(String name) {
        super(name, (new WNBiomeBuilder())
                .surfaceBuilder(WNSurfaceBuilders.RIVER_SURFACE_BUILDER, new CanyonSurfaceBuilderConfig(WNSurfaceBuilders.BROWN_PODZOL_GRAVEL, SurfaceBuilder.DEFAULT))
                ...
                .logTypes(LogType.OAK,LogType.SPRUCE,LogType.FIR,LogType.SEASONAL_BIRCH_YELLOW)
                .parent(null));
