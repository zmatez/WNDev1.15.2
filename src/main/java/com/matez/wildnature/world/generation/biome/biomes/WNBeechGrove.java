...
public class WNBeechGrove extends WNBiome {
    public WNBeechGrove(String name) {
        ...
        WNBiomeFeatures.addGrass(this, 14, WNBlocks.LAVENDER.getDefaultState().with(FloweringBushBase.FLOWERING,true));
        WNBiomeFeatures.addGrass(this, 4, Blocks.GRASS.getDefaultState());
        ...
        WNBiomeFeatures.addTree(this, new thick_beech1().setCustomLeafOverride(SchemFeature.notDecayingLeaf(WNBlocks.PURPLE_BEECH_LEAVES)), 1);
        WNBiomeFeatures.addTree(this, new thick_beech2().setCustomLeafOverride(SchemFeature.notDecayingLeaf(WNBlocks.PURPLE_BEECH_LEAVES)), 1);
        WNBiomeFeatures.addTree(this, new thick_beech3().setCustomLeafOverride(SchemFeature.notDecayingLeaf(WNBlocks.PURPLE_BEECH_LEAVES)), 1);
