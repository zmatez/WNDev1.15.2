...
public class cedar4 extends SchemFeature {
    public cedar4() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(-1, 2, -3, "wildnature:cedar_leaves[distance=7,persistent=true]");
        ...
        Block(0, 9, -1, "wildnature:cedar_leaves[distance=3,persistent=true]");
