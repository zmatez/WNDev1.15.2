...
public class WNCaatingaHills extends WNBiome {
    public WNCaatingaHills(String name) {
        super(name, (new WNBiomeBuilder())
                .surfaceBuilder(WNSurfaceBuilders.CUSTOM_SURFACE_BUILDER, new CustomSurfaceBuilderConfig(new CustomSurfaceBuilder.BlockCfg(new SurfaceBuilderConfig(Blocks.SANDSTONE.getDefaultState(),Blocks.SANDSTONE.getDefaultState(), Blocks.SANDSTONE.getDefaultState()), 4), new CustomSurfaceBuilder.BlockCfg(SurfaceBuilder.SAND_CONFIG, 1), new CustomSurfaceBuilder.BlockCfg(WNSurfaceBuilders.DESERT_CONFIG, 1)))
        ...
        WNBiomeFeatures.addBlob(this, Blocks.SAND.getDefaultState(), 2, true, true, 2);
