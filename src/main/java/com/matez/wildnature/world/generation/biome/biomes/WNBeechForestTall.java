...
public class WNBeechForestTall extends WNBiome {
    public WNBeechForestTall(String name) {
        super(name, (new WNBiomeBuilder())
                ...
                .logTypes(LogType.BEECH_THICK, LogType.BEECH)
                .parent(null));
        ...
        WNBiomeFeatures.addTree(this, new high_beech_1(), 3);
        WNBiomeFeatures.addTree(this, new high_beech_2(), 3);
        WNBiomeFeatures.addTree(this, new high_beech_3(), 3);
        WNBiomeFeatures.addTree(this, new high_beech_4(), 3);
        WNBiomeFeatures.addTree(this, new high_beech_5(), 3);
