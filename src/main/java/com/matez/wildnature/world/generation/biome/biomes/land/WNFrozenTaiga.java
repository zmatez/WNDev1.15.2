...
import com.matez.wildnature.world.generation.structures.nature.woods.fir.tree_fir23;
import com.matez.wildnature.world.generation.structures.nature.woods.fir.tree_fir25;
...
public class WNFrozenTaiga extends WNBiome {
    public WNFrozenTaiga(String name) {
        super(name, (new WNBiomeBuilder())
                ...
                .logTypes(LogType.PINE,LogType.SPRUCE,LogType.PINE_THICK,LogType.SMALL_BIRCH,LogType.BIRCH_THICK,LogType.BEECH,LogType.BEECH_THICK,LogType.LARCH,LogType.ROWAN,LogType.PURPLE_BEECH)
                .parent(null));
        ...
        WNBiomeFeatures.addTree(this, new tree_larch1().setCustomLog(WN.getBlockByID("wildnature:larch_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:larch_leaves"))), 1);
        WNBiomeFeatures.addTree(this, new tree_larch2().setCustomLog(WN.getBlockByID("wildnature:larch_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:larch_leaves"))), 1);
        WNBiomeFeatures.addTree(this, new tree_larch3().setCustomLog(WN.getBlockByID("wildnature:larch_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:larch_leaves"))), 1);
        WNBiomeFeatures.addTree(this, new tree_larch4().setCustomLog(WN.getBlockByID("wildnature:larch_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:larch_leaves"))), 1);
        WNBiomeFeatures.addTree(this, new tree_larch5().setCustomLog(WN.getBlockByID("wildnature:larch_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:larch_leaves"))), 1);
        WNBiomeFeatures.addTree(this, new tree_larch6().setCustomLog(WN.getBlockByID("wildnature:larch_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:larch_leaves"))), 1);
        WNBiomeFeatures.addTree(this, new tree_larch7().setCustomLog(WN.getBlockByID("wildnature:larch_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:larch_leaves"))), 1);
        WNBiomeFeatures.addTree(this, new tree_larch8().setCustomLog(WN.getBlockByID("wildnature:larch_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:larch_leaves"))), 1);
        WNBiomeFeatures.addTree(this, new tree_larch9().setCustomLog(WN.getBlockByID("wildnature:larch_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:larch_leaves"))), 1);
        WNBiomeFeatures.addTree(this, new tree_spruce_big1().setCustomLog(WN.getBlockByID("wildnature:pine_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:pine_leaves"))), 5);
        WNBiomeFeatures.addTree(this, new tree_spruce_big2().setCustomLog(WN.getBlockByID("wildnature:pine_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:pine_leaves"))), 5);
        WNBiomeFeatures.addTree(this, new tree_spruce_big3().setCustomLog(WN.getBlockByID("wildnature:pine_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:pine_leaves"))), 5);
        WNBiomeFeatures.addTree(this, new tree_spruce_big4().setCustomLog(WN.getBlockByID("wildnature:pine_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:pine_leaves"))), 5);
        WNBiomeFeatures.addTree(this, new tree_spruce_m1().setCustomLog(WN.getBlockByID("wildnature:pine_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:pine_leaves"))), 1);
        WNBiomeFeatures.addTree(this, new tree_spruce_m2().setCustomLog(WN.getBlockByID("wildnature:pine_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:pine_leaves"))), 1);
        WNBiomeFeatures.addTree(this, new tree_spruce_m3().setCustomLog(WN.getBlockByID("wildnature:pine_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:pine_leaves"))), 1);
        WNBiomeFeatures.addTree(this, new tree_spruce_m4().setCustomLog(WN.getBlockByID("wildnature:pine_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:pine_leaves"))), 1);
        WNBiomeFeatures.addTree(this, new tree_spruce_m5().setCustomLog(WN.getBlockByID("wildnature:pine_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:pine_leaves"))), 1);
        WNBiomeFeatures.addTree(this, new tree_spruce_m6().setCustomLog(WN.getBlockByID("wildnature:pine_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:pine_leaves"))), 1);
        WNBiomeFeatures.addTree(this, new tree_spruce_m7().setCustomLog(WN.getBlockByID("wildnature:pine_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:pine_leaves"))), 1);
        WNBiomeFeatures.addTree(this, new tree_spruce_m8().setCustomLog(WN.getBlockByID("wildnature:pine_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:pine_leaves"))), 1);
        WNBiomeFeatures.addTree(this, new tree_spruce_m9().setCustomLog(WN.getBlockByID("wildnature:pine_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:pine_leaves"))), 1);

        WNBiomeFeatures.addTree(this, new tree_taiga11().setCustomLog(WN.getBlockByID("minecraft:spruce_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("minecraft:spruce_leaves"))), 10);
        WNBiomeFeatures.addTree(this, new tree_taiga12().setCustomLog(WN.getBlockByID("minecraft:spruce_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("minecraft:spruce_leaves"))), 10);
        ...
        WNBiomeFeatures.addTree(this, new tree_fir13().setCustomLog(WN.getBlockByID("minecraft:spruce_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:fir_leaves"))), 5);
        WNBiomeFeatures.addTree(this, new tree_fir25().setCustomLog(WN.getBlockByID("minecraft:spruce_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:fir_leaves"))), 5);
        WNBiomeFeatures.addTree(this, new tree_fir23().setCustomLog(WN.getBlockByID("minecraft:spruce_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:fir_leaves"))), 2);
        WNBiomeFeatures.addTree(this, new tree_fir22().setCustomLog(WN.getBlockByID("minecraft:spruce_log").getDefaultState()).setCustomLeaf(SchemFeature.notDecayingLeaf(WN.getBlockByID("wildnature:fir_leaves"))), 5);
