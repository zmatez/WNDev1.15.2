...
public class fallen_spruce_4 extends FallenSchemFeature {
    

    @Override
    public Set<BlockPos> setBlocks() {

Block(0,1,-5,"minecraft:spruce_leaves[distance=3,persistent=true]");
Block(1,1,-5,"minecraft:spruce_leaves[distance=4,persistent=true]");
Block(-1,1,-4,"minecraft:spruce_leaves[distance=3,persistent=true]");
Block(0,1,-4,"minecraft:spruce_leaves[distance=2,persistent=true]");
...
Block(-1,1,-3,"minecraft:spruce_leaves[distance=2,persistent=true]");
Block(0,1,-3,"minecraft:spruce_leaves[distance=1,persistent=true]");
Block(1,1,-3,"minecraft:spruce_leaves[distance=2,persistent=true]");
Block(0,2,-3,"minecraft:spruce_leaves[distance=2,persistent=true]");
...
Block(0,1,2,"minecraft:spruce_log[axis=z]");
Block(1,1,2,"minecraft:spruce_leaves[distance=1,persistent=true]");
Block(0,0,3,"minecraft:spruce_log[axis=y]");
