...
public class fallen_paradise_apple_1 extends FallenSchemFeature {


    @Override
    public Set<BlockPos> setBlocks() {

        Block(-3, 1, -5, "minecraft:oak_leaves[distance=7,persistent=true]");
        Block(0, 1, -5, "minecraft:vine[east=false,north=false,south=true,up=false,west=false]");
        Block(2, 1, -5, "minecraft:oak_leaves[distance=7,persistent=true]");
        Block(-2, 1, -4, "minecraft:oak_leaves[distance=4,persistent=true]");
        Block(0, 1, -4, "minecraft:oak_leaves[distance=4,persistent=true]");
        Block(1, 1, -4, "minecraft:oak_leaves[distance=5,persistent=true]");
        Block(2, 1, -4, "minecraft:vine[east=false,north=true,south=true,up=false,west=true]");
        ...
        Block(-2, 1, -3, "minecraft:oak_leaves[distance=3,persistent=true]");
        Block(-1, 1, -3, "minecraft:oak_leaves[distance=2,persistent=true]");
        Block(0, 1, -3, "minecraft:oak_leaves[distance=3,persistent=true]");
        Block(2, 1, -3, "minecraft:oak_leaves[distance=4,persistent=true]");
        ...
        Block(3, 1, -2, "minecraft:vine[east=false,north=false,south=false,up=false,west=true]");
        Block(4, 1, -2, "minecraft:oak_leaves[distance=7,persistent=true]");
        Block(-1, 2, -2, "minecraft:oak_leaves[distance=2,persistent=true]");
        Block(0, 2, -2, "minecraft:oak_leaves[distance=3,persistent=true]");
        Block(-4, 1, -1, "minecraft:oak_leaves[distance=2,persistent=true]");
        ...
        Block(0, 1, 0, "minecraft:vine[east=false,north=false,south=true,up=false,west=false]");
        Block(1, 1, 0, "minecraft:oak_log[axis=z]");
        Block(2, 1, 0, "minecraft:oak_leaves[distance=1,persistent=true]");
        ...
        Block(0, 2, 0, "minecraft:vine[east=false,north=false,south=true,up=false,west=false]");
        ...
        Block(0, 2, 3, "minecraft:oak_leaves[distance=1,persistent=true]");
        Block(1, 2, 3, "minecraft:oak_leaves[distance=2,persistent=true]");
