...
import com.matez.wildnature.world.generation.structures.nature.woods.cherry.wild_cherry3;
...
public class WNTemperateRedwoodScrubs extends WNBiome {
    public WNTemperateRedwoodScrubs(String name) {
        super(name, (new WNBiomeBuilder())
                ...
                .logTypes(LogType.REDWOOD,LogType.WEEPING_CEDAR,LogType.SMALL_OAK,LogType.PEAR,LogType.PLUM,LogType.MIRABELLE_PLUM,LogType.FORSYTHIA,LogType.MAGNOLIA,LogType.WILD_CHERRY)
                .parent(null));
        ...
        BlockState redwoodLog = WN.getBlockByID("wildnature:redwood_log").getDefaultState();
        BlockState redwoodLeaves = tree_taiga1.notDecayingLeaf(WN.getBlockByID("wildnature:redwood_leaves"));
