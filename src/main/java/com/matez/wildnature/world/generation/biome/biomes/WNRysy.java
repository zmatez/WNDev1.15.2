...
public class WNRysy extends WNBiome {
    public WNRysy(String name) {
        super(name, (new WNBiomeBuilder())
                ...
                .logTypes(LogType.PINE,LogType.SPRUCE,LogType.FIR)
                .parent(null));
        ...
        BlockState pineLog = WN.getBlockByID("wildnature:pine_log").getDefaultState();
        BlockState pineLeaves = tree_taiga1.notDecayingLeaf(WN.getBlockByID("wildnature:pine_leaves"));
        BlockState firLog = WN.getBlockByID("wildnature:fir_log").getDefaultState();
