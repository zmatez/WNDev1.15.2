...
public class WNDeciduousForest extends WNBiome {
    public WNDeciduousForest(String name) {
        super(name, (new WNBiomeBuilder())
                .surfaceBuilder(WNSurfaceBuilders.CUSTOM_SURFACE_BUILDER, new CustomSurfaceBuilderConfig(new CustomSurfaceBuilder.BlockCfg(SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG, 3), new CustomSurfaceBuilder.BlockCfg(SurfaceBuilder.PODZOL_DIRT_GRAVEL_CONFIG, 1)))
                ...
                .logTypes(LogType.BIRCH,LogType.OAK,LogType.HORNBEAM)
                .parent(null));
        ...
        WNBiomeFeatures.addTree(this, new tree_birch10().setCustomLog(WN.getBlockByID("minecraft:oak_log").getDefaultState()).setCustomLeaf(tree_birch1.notDecayingLeaf(WN.getBlockByID("wildnature:poplar_leaves"))), 1);
        ...
        WNBiomeFeatures.addTree(this, new tree_birch11().setCustomLog(WN.getBlockByID("minecraft:birch_log").getDefaultState()).setCustomLeaf(tree_birch1.notDecayingLeaf(WN.getBlockByID("wildnature:aspen_leaves"))), 1);
        WNBiomeFeatures.addTree(this, new tree_birch12().setCustomLog(WN.getBlockByID("minecraft:birch_log").getDefaultState()).setCustomLeaf(tree_birch1.notDecayingLeaf(WN.getBlockByID("wildnature:aspen_leaves"))), 1);
        WNBiomeFeatures.addTree(this, new tree_oak31().setCustomLog(WN.getBlockByID("minecraft:oak_log").getDefaultState()).setCustomLeaf(tree_birch1.notDecayingLeaf(WN.getBlockByID("wildnature:hornbeam_leaves"))), 3);
        WNBiomeFeatures.addTree(this, new tree_hornbeam1().setCustomLog(WN.getBlockByID("minecraft:oak_log").getDefaultState()).setCustomLeaf(tree_birch1.notDecayingLeaf(WN.getBlockByID("wildnature:hornbeam_leaves"))), 1);
