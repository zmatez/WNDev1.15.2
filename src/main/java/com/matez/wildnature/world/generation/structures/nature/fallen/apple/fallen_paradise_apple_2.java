...
public class fallen_paradise_apple_2 extends FallenSchemFeature {
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(1, 1, -4, "minecraft:oak_leaves[distance=2,persistent=true]");
        Block(5, 1, -4, "minecraft:oak_leaves[distance=7,persistent=true]");
        ...
        Block(0, 1, -3, "minecraft:oak_leaves[distance=2,persistent=true]");
        ...
        Block(5, 1, -1, "minecraft:oak_leaves[distance=1,persistent=true]");
        ...
        Block(3, 2, -1, "minecraft:oak_leaves[distance=2,persistent=true]");
        Block(4, 2, -1, "minecraft:oak_leaves[distance=1,persistent=true]");
        Block(2, 3, -1, "minecraft:oak_leaves[distance=2,persistent=true]");
        ...
        Block(0, 1, 0, "minecraft:oak_leaves[distance=1,persistent=true]");
        Block(1, 1, 0, "minecraft:oak_leaves[distance=2,persistent=true]");
        ...
        Block(1, 2, 0, "minecraft:oak_leaves[distance=3,persistent=true]");
        ...
        Block(1, 1, 6, "minecraft:oak_log[axis=y]");
