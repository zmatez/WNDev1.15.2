...
import com.matez.wildnature.world.generation.structures.nature.woods.pine.tall_pine1;
import com.matez.wildnature.world.generation.structures.nature.woods.pine.tall_pine2;
import com.matez.wildnature.world.generation.structures.nature.woods.pine.tall_pine3;
import com.matez.wildnature.world.generation.structures.nature.woods.pine.tall_pine4;
...
public class WNTemperateSequoiaRainforest extends WNBiome {
    public WNTemperateSequoiaRainforest(String name) {
        ...
        WNBiomeFeatures.addTree(this, new sequoia1().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_GREEN_LEAVES)), 5);
        WNBiomeFeatures.addTree(this, new sequoia2().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_GREEN_LEAVES)), 5);
        WNBiomeFeatures.addTree(this, new sequoia3().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_GREEN_LEAVES)), 5);
        WNBiomeFeatures.addTree(this, new sequoia4().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_GREEN_LEAVES)), 5);
        WNBiomeFeatures.addTree(this, new sequoia5().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_GREEN_LEAVES)), 5);
        WNBiomeFeatures.addTree(this, new sequoia6().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_GREEN_LEAVES)), 5);
        ...
        WNBiomeFeatures.addTree(this, new oaklands_oak3().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_YELLOW_LEAVES)), 1);
        WNBiomeFeatures.addTree(this, new oaklands_oak4().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_YELLOW_LEAVES)), 1);
        WNBiomeFeatures.addTree(this, new oaklands_oak5().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_YELLOW_LEAVES)), 1);
        WNBiomeFeatures.addTree(this, new oaklands_oak6().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_YELLOW_LEAVES)), 1);
        WNBiomeFeatures.addTree(this, new oaklands_oak7().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_YELLOW_LEAVES)), 1);
        WNBiomeFeatures.addTree(this, new oaklands_oak8().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_YELLOW_LEAVES)), 1);

        WNBiomeFeatures.addTree(this, new rowan4(), 1);
        //WNBiomeFeatures.addTree(this, new wild_cherry2(), 1);

        WNBiomeFeatures.addTree(this, new oaklands_smallshrub1().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_YELLOW_LEAVES)), 3);
        ...
        WNBiomeFeatures.addTree(this, new oaklands_smallshrub3().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_YELLOW_LEAVES)), 3);
        WNBiomeFeatures.addTree(this, new shrub1().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_YELLOW_LEAVES)), 10);
    ...
    public int getGrassColor(BlockPos pos) {
        ...
        return customColor(noise, -0.1D, 0x81EE59, 0x78DA42);
    }
