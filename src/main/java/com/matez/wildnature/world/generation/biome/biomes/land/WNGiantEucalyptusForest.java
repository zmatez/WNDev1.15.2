...
public class WNGiantEucalyptusForest extends WNBiome {
    public WNGiantEucalyptusForest(String name) {
        super(name, (new WNBiomeBuilder())
                .surfaceBuilder(WNSurfaceBuilders.CUSTOM_SURFACE_BUILDER, new CustomSurfaceBuilderConfig(new CustomSurfaceBuilder.BlockCfg(WNSurfaceBuilders.TROPICAL_CONFIG, 2), new CustomSurfaceBuilder.BlockCfg(SurfaceBuilder.PODZOL_DIRT_GRAVEL_CONFIG, 3)))
                ...
                .logTypes(LogType.EUCALYPTUS, LogType.BIG_EUCALYPTUS)
                .parent(null));
        ...
        WNBiomeFeatures.addPlant(this, WNBlocks.ANTHURIUM_WHITE.getDefaultState().with(FloweringBushBase.FLOWERING, true), 2);
        ...
        WNBiomeFeatures.addTree(this, new big_eucalyptus1(), 6);
        WNBiomeFeatures.addTree(this, new big_eucalyptus2(), 6);
        WNBiomeFeatures.addTree(this, new big_eucalyptus3(), 6);
        WNBiomeFeatures.addTree(this, new big_eucalyptus4(), 6);
        WNBiomeFeatures.addTree(this, new big_eucalyptus1().setCustomLogOverride(WNBlocks.RAINBOW_EUCALYPTUS_LOG.getDefaultState()), 1);
        WNBiomeFeatures.addTree(this, new big_eucalyptus2().setCustomLogOverride(WNBlocks.RAINBOW_EUCALYPTUS_LOG.getDefaultState()), 1);
        ...
        this.addSpawn(EntityClassification.CREATURE, new SpawnListEntry(EntityType.PANDA, 8, 2, 4));
        this.addSpawn(EntityClassification.CREATURE, new SpawnListEntry(EntityType.CHICKEN, 10, 4, 4));
