...
import com.matez.wildnature.world.generation.structures.nature.woods.shrubs.*;
...
public class WNShrublandPlateau extends WNBiome {
    public WNShrublandPlateau(String name) {
