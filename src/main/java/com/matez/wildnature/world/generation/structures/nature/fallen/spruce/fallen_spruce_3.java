...
public class fallen_spruce_3 extends FallenSchemFeature {
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(1, 1, -4, "minecraft:spruce_leaves[distance=4,persistent=true]");
        ...
        Block(0, 1, -3, "minecraft:spruce_leaves[distance=2,persistent=true]");
        Block(1, 1, -3, "minecraft:spruce_leaves[distance=3,persistent=true]");
        ...
        Block(1, 1, -2, "minecraft:spruce_leaves[distance=2,persistent=true]");
        Block(2, 1, -2, "minecraft:spruce_leaves[distance=3,persistent=true]");
        ...
        Block(1, 1, 0, "minecraft:spruce_leaves[distance=1,persistent=true]");
        Block(-2, 2, 0, "minecraft:spruce_leaves[distance=3,persistent=true]");
