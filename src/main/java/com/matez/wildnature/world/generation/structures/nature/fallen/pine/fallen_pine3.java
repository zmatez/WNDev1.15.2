...
public class fallen_pine3 extends FallenSchemFeature {


    @Override
    public Set<BlockPos> setBlocks() {

        Block(0, 0, -12, "wildnature:pine_log[axis=y]");
        Block(0, 1, -12, "minecraft:vine[east=false,north=false,south=true,up=false,west=false]");
        Block(0, 1, -11, "wildnature:pine_log[axis=z]");
        Block(0, 1, -10, "wildnature:pine_log[axis=z]");
        Block(-1, 1, -9, "minecraft:vine[east=true,north=false,south=false,up=false,west=false]");
        Block(0, 1, -9, "wildnature:pine_log[axis=z]");
        Block(0, 1, -8, "wildnature:pine_log[axis=z]");
