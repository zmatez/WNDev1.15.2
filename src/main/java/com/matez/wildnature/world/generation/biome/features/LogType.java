...
public enum LogType {
    ...
    JUNGLE_BIG(Blocks.JUNGLE_LOG, Blocks.JUNGLE_LEAVES),
    JUNGLE_MEDIUM(Blocks.JUNGLE_LOG, Blocks.JUNGLE_LEAVES),
    JUNGLE_SMALL(Blocks.JUNGLE_LOG, Blocks.JUNGLE_LEAVES),
    ...
    ROWAN(Blocks.OAK_LOG,WNBlocks.ROWAN_LEAVES),
