...
public class fallen_birch1 extends FallenSchemFeature {
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(0, 1, -4, "minecraft:vine[east=false,north=true,south=true,up=false,west=false]");
        ...
        Block(0, 1, 3, "minecraft:birch_leaves[distance=2,persistent=true]");
        Block(1, 1, 3, "minecraft:birch_leaves[distance=3,persistent=true]");
        Block(0, 1, 4, "minecraft:birch_leaves[distance=3,persistent=true]");
//   wildnature mod
//           created by matez 
//         all rights reserved   
