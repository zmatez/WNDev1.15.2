...
public class WNCrackedDesert extends WNBiome {
    public WNCrackedDesert(String name) {
        super(name, (new WNBiomeBuilder())
                .surfaceBuilder(WNSurfaceBuilders.CRACKED_SURFACE_BUILDER, new SurfaceBuilderConfig(WN.getBlockByID("wildnature:cracked_sandstone").getDefaultState(), WN.getBlockByID("wildnature:cracked_sandstone").getDefaultState(), WN.getBlockByID("minecraft:sand").getDefaultState()))
