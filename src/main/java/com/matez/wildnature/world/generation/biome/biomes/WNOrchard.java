...
public class WNOrchard extends WNBiome {
    public WNOrchard(String name) {
        ...
        WNBiomeFeatures.addTree(this, new tree_oak5().setCustomLog(WN.getBlockByID("minecraft:oak_log").getDefaultState()).setCustomLeaf(tree_birch1.notDecayingLeaf(WN.getBlockByID("minecraft:oak_leaves"))), 4);
