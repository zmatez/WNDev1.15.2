...
public class fallen_mini_pine5 extends FallenSchemFeature {
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(-5, 0, 0, "wildnature:pine_log[axis=y]");
        Block(-5, 1, 0, "wildnature:pine_log[axis=y]");
        ...
        Block(1, 1, 0, "wildnature:pine_log[axis=x]");
        Block(2, 1, 0, "wildnature:pine_log[axis=x]");
        Block(3, 1, 0, "wildnature:pine_leaves[distance=1,persistent=true]");
        ...
        Block(0, 1, 1, "wildnature:pine_leaves[distance=1,persistent=true]");
        Block(1, 1, 1, "wildnature:pine_leaves[distance=1,persistent=true]");
        Block(3, 1, 1, "wildnature:pine_leaves[distance=2,persistent=true]");
