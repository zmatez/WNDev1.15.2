...
public class fallen_mini_pine5 extends FallenSchemFeature {
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(0, 2, -1, "minecraft:vine[east=false,north=false,south=true,up=false,west=true]");
        Block(-5, 0, 0, "minecraft:spruce_log[axis=y]");
        Block(-5, 1, 0, "minecraft:spruce_log[axis=y]");
        ...
        Block(0, 1, 1, "minecraft:spruce_leaves[distance=1,persistent=true]");
        Block(1, 1, 1, "minecraft:spruce_leaves[distance=1,persistent=true]");
        Block(3, 1, 1, "minecraft:spruce_leaves[distance=2,persistent=true]");
