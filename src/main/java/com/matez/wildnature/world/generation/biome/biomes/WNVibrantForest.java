...
import com.matez.wildnature.world.generation.structures.nature.woods.cypress.cypress1;
import com.matez.wildnature.world.generation.structures.nature.woods.cypress.cypress2;
import com.matez.wildnature.world.generation.structures.nature.woods.cypress.cypress3;
import com.matez.wildnature.world.generation.structures.nature.woods.cypress.cypress4;
...
import com.matez.wildnature.world.generation.structures.nature.woods.rowan.rowan2;
...
import com.matez.wildnature.world.generation.structures.nature.woods.small_redwood.*;
...
public class WNVibrantForest extends WNBiome {
    public WNVibrantForest(String name) {
        super(name, (new WNBiomeBuilder())
                ...
                .logTypes(LogType.REDWOOD,LogType.WEEPING_CEDAR,LogType.SMALL_BIRCH,LogType.CYPRESS,LogType.PEAR,LogType.APPLE,LogType.PLUM,LogType.MIRABELLE_PLUM,LogType.ROWAN,LogType.SMALL_OAK,LogType.FORSYTHIA,LogType.MAGNOLIA)
                .parent(null));
        ...
        WNBiomeFeatures.addTree(this, new tree_oak5().setCustomLog(WN.getBlockByID("wildnature:plum_log").getDefaultState()).setCustomLeaf(tree_birch1.notDecayingLeaf(WN.getBlockByID("wildnature:plum_leaves"))), 1);
        WNBiomeFeatures.addTree(this, new tree_oak5().setCustomLog(WN.getBlockByID("wildnature:plum_log").getDefaultState()).setCustomLeaf(tree_birch1.notDecayingLeaf(WN.getBlockByID("wildnature:mirabelle_plum_leaves"))), 2);
