...
public class WNWoodedJacarandaMeadow extends WNBiome {
    public WNWoodedJacarandaMeadow(String name) {
        super(name, (new WNBiomeBuilder())
                ...
                .logTypes(LogType.OAK,LogType.SMALL_OAK,LogType.APPLE,LogType.PEAR, LogType.JACARANDA)
                .parent(null));
        ...
        WNBiomeFeatures.addTree(this, new jacaranda2(), 2);
        WNBiomeFeatures.addTree(this, new jacaranda3(), 2);
