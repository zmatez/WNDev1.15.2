...
public class fallen_oak_4 extends FallenSchemFeature {
...
Block(0,1,-2,"minecraft:oak_leaves[distance=3,persistent=true]");
Block(1,1,-2,"minecraft:oak_leaves[distance=4,persistent=true]");
...
Block(0,1,-1,"minecraft:oak_leaves[distance=2,persistent=true]");
Block(1,1,-1,"minecraft:oak_leaves[distance=3,persistent=true]");
Block(-2,2,-1,"minecraft:vine[east=true,north=false,south=false,up=false,west=false]");
Block(-1,2,-1,"minecraft:oak_leaves[distance=4,persistent=true]");
Block(0,2,-1,"minecraft:oak_leaves[distance=3,persistent=true]");
