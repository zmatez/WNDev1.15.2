...
public class fallen_tall_birch4 extends FallenSchemFeature {
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(-2, 1, 0, "minecraft:vine[east=true,north=false,south=true,up=false,west=false]");
        ...
        Block(-3, 1, 2, "minecraft:birch_leaves[distance=2,persistent=true]");
        ...
        Block(1, 1, 2, "minecraft:birch_leaves[distance=2,persistent=true]");
        Block(-3, 2, 2, "minecraft:vine[east=true,north=false,south=false,up=false,west=false]");
        Block(-2, 2, 2, "minecraft:birch_leaves[distance=2,persistent=true]");
