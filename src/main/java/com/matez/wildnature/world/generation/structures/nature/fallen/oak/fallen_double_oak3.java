...
public class fallen_double_oak3 extends FallenSchemFeature {
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(1, 0, -7, "minecraft:oak_log[axis=y]");
        Block(-1, 1, -7, "minecraft:oak_log[axis=y]");
        Block(0, 1, -7, "minecraft:oak_log[axis=y]");
        Block(0, 2, -7, "minecraft:oak_log[axis=y]");
        ...
        Block(0, 1, -6, "minecraft:oak_log[axis=y]");
        Block(1, 1, -6, "wildnature:grape_vine_purple[east=false,flowering=true,north=false,south=false,up=false,west=true]");
        ...
        Block(1, 1, -2, "wildnature:grape_vine_purple[east=false,flowering=true,north=true,south=false,up=false,west=false]");
        ...
        Block(2, 2, 0, "wildnature:grape_vine_purple[east=false,flowering=true,north=false,south=true,up=false,west=false]");
        ...
        Block(-3, 1, 2, "minecraft:oak_leaves[distance=4,persistent=true]");
        ...
        Block(-1, 1, 4, "minecraft:oak_leaves[distance=4,persistent=true]");
        Block(0, 1, 4, "minecraft:oak_leaves[distance=3,persistent=true]");
