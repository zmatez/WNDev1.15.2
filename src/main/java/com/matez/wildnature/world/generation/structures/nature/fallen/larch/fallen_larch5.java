...
public class fallen_larch5 extends FallenSchemFeature {
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(0, 2, -2, "wildnature:larch_leaves[distance=1,persistent=true,stage=2]");
        Block(-2, 1, -1, "wildnature:larch_leaves[distance=2,persistent=true,stage=2]");
        Block(-1, 1, -1, "wildnature:larch_leaves[distance=1,persistent=true,stage=3]");
        Block(0, 1, -1, "wildnature:larch_log[axis=z]");
        Block(1, 1, -1, "wildnature:larch_leaves[distance=1,persistent=true,stage=6]");
        Block(2, 1, -1, "wildnature:larch_leaves[distance=2,persistent=true,stage=5]");
        Block(-1, 2, -1, "wildnature:larch_leaves[distance=2,persistent=true,stage=5]");
        ...
        Block(1, 1, 0, "wildnature:larch_leaves[distance=1,persistent=true,stage=3]");
        ...
        Block(0, 2, 0, "wildnature:larch_leaves[distance=1,persistent=true,stage=6]");
        Block(1, 2, 0, "wildnature:larch_leaves[distance=2,persistent=true,stage=6]");
        ...
        Block(2, 1, 2, "wildnature:larch_leaves[distance=2,persistent=true,stage=6]");
        Block(-1, 2, 2, "wildnature:larch_leaves[distance=2,persistent=true,stage=4]");
        Block(0, 2, 2, "wildnature:larch_leaves[distance=1,persistent=true,stage=5]");
        Block(1, 2, 2, "wildnature:larch_leaves[distance=2,persistent=true,stage=6]");
        ...
        Block(0, 2, 4, "wildnature:larch_leaves[distance=1,persistent=true,stage=2]");
        Block(-1, 1, 5, "wildnature:larch_leaves[distance=2,persistent=true,stage=4]");
        Block(0, 1, 5, "wildnature:larch_leaves[distance=1,persistent=true,stage=5]");
        Block(-1, 1, 6, "minecraft:vine[east=false,north=true,south=false,up=false,west=false]");
        Block(0, 1, 6, "wildnature:larch_leaves[distance=2,persistent=true,stage=5]");
