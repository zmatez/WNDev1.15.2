...
@OnlyIn(Dist.CLIENT)
public class BackpackMediumScreen extends ContainerScreen<BackpackMediumContainer> {
   private static final ResourceLocation BACKPACK_TEXTURE = new ResourceLocation("wildnature:textures/gui/backpack_medium.png");

   public BackpackMediumScreen(BackpackMediumContainer backpack, PlayerInventory inv, ITextComponent text) {
