...
@OnlyIn(Dist.CLIENT)
public class BackpackSmallScreen extends ContainerScreen<BackpackSmallContainer> {
   private static final ResourceLocation BACKPACK_TEXTURE = new ResourceLocation("wildnature:textures/gui/backpack_small.png");

   public BackpackSmallScreen(BackpackSmallContainer backpack, PlayerInventory inv, ITextComponent text) {
