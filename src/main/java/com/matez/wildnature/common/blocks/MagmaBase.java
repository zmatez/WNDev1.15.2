...
public class MagmaBase extends BlockBase {
    public MagmaBase(Properties properties, Item.Properties builder, ResourceLocation regName) {
        super(properties, builder, regName);
    }

    public MagmaBase(Properties properties, ResourceLocation regName) {
        super(properties, regName);
    }

    public MagmaBase(Properties properties, Item.Properties builder, String drop, int min, int max, int exp, ResourceLocation regName) {
