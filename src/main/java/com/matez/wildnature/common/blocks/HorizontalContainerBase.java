...
public abstract class HorizontalContainerBase extends ContainerBase{
    public static final DirectionProperty FACING;

    public HorizontalContainerBase(Properties properties, Item.Properties builder, ResourceLocation regName) {
        super(properties, builder, regName);
        this.setDefaultState((BlockState)((BlockState)this.getStateContainer().getBaseState()).with(FACING, Direction.NORTH));
    }

    public HorizontalContainerBase(Properties properties, ResourceLocation regName) {
