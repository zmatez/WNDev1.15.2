...
public class SchemListCommand {
    ...
    public int showPage(int page){
        ...
        StringTextComponent s = new StringTextComponent(TextFormatting.GREEN+"SchemFeature List "+TextFormatting.GRAY+" - - - "+TextFormatting.LIGHT_PURPLE+" page " + TextFormatting.AQUA + page + TextFormatting.DARK_AQUA + "/"+TextFormatting.AQUA+maxPages);
        ITextComponent hovermsg = new StringTextComponent(TextFormatting.GRAY + "Showing " + TextFormatting.DARK_AQUA+ SchemFeature.schemFeatures.size() + TextFormatting.GRAY+" features");
        ...
        s2.getStyle().setClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND,"/wn schem list " +(page+1)+""));
