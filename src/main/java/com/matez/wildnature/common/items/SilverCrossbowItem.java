...
public class SilverCrossbowItem extends ShootableItem {
    ...
    private static float func_220013_l(ItemStack p_220013_0_) {
        return p_220013_0_.getItem() == WNItems.SILVER_CROSSBOW && hasChargedProjectile(p_220013_0_, Items.FIREWORK_ROCKET) ? 1.6F : 3.15F;
    }
}