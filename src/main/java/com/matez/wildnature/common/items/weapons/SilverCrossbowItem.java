...
public class SilverCrossbowItem extends CrossbowItem {
    ...
    private static AbstractArrowEntity createArrow(World worldIn, LivingEntity shooter, ItemStack crossbow, ItemStack ammo) {
        ...
        abstractarrowentity.setDamage(3.5f);
    ...
    private static float func_220013_l(ItemStack p_220013_0_) {
        return p_220013_0_.getItem() instanceof CrossbowItem && hasChargedProjectile(p_220013_0_, Items.FIREWORK_ROCKET) ? 1.9F : 4.5F;
    }
}