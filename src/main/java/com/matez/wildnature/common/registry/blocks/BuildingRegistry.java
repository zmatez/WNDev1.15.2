...
public class BuildingRegistry {
    ...
    */
    ...
    public BuildingRegistry() {
        rocks = new Block[]{
                WNBlocks.SANDSTONE_BRICKS = new BlockBase(Block.Properties.create(Material.ROCK, MaterialColor.SAND).hardnessAndResistance(1.5F, 6.0F), new Item.Properties().group(WNTabs.ROCK_BUILDING), WN.RegistryEvents.location("sandstone_bricks")),
                WNBlocks.SANDSTONE_ANCIENT_BRICKS = new BlockBase(Block.Properties.create(Material.ROCK, MaterialColor.SAND).hardnessAndResistance(0.8F), new Item.Properties().group(WNTabs.ROCK_BUILDING), WN.RegistryEvents.location("sandstone_ancient_bricks")),
                WNBlocks.WHITE_SANDSTONE_SLAB = new SlabBase(Block.Properties.create(Material.ROCK, MaterialColor.WHITE_TERRACOTTA).hardnessAndResistance(0.8F,0.5F), new Item.Properties().group(WNTabs.ROCK_BUILDING), WN.RegistryEvents.location("white_sandstone_slab")),
                WNBlocks.WHITE_SANDSTONE_STAIRS = new StairsBase(WNBlocks.WHITE_SANDSTONE.getDefaultState(),Block.Properties.create(Material.ROCK, MaterialColor.WHITE_TERRACOTTA).hardnessAndResistance(0.8F,0.5F), new Item.Properties().group(WNTabs.ROCK_BUILDING), WN.RegistryEvents.location("white_sandstone_stairs")),
                WNBlocks.WHITE_SANDSTONE_WALL = new WallBase(Block.Properties.create(Material.ROCK, MaterialColor.WHITE_TERRACOTTA).hardnessAndResistance(0.8F,0.5F), new Item.Properties().group(WNTabs.ROCK_BUILDING), WN.RegistryEvents.location("white_sandstone_wall")),
                WNBlocks.SMOOTH_WHITE_SANDSTONE = new BlockBase(Block.Properties.create(Material.ROCK, MaterialColor.WHITE_TERRACOTTA).hardnessAndResistance(0.8F,0.5F), new Item.Properties().group(WNTabs.ROCK_BUILDING), WN.RegistryEvents.location("smooth_white_sandstone")),
                WNBlocks.SMOOTH_WHITE_SANDSTONE_SLAB = new SlabBase(Block.Properties.create(Material.ROCK, MaterialColor.WHITE_TERRACOTTA).hardnessAndResistance(0.8F,0.5F), new Item.Properties().group(WNTabs.ROCK_BUILDING), WN.RegistryEvents.location("smooth_white_sandstone_slab")),
                WNBlocks.SMOOTH_WHITE_SANDSTONE_STAIRS = new StairsBase(WNBlocks.SMOOTH_WHITE_SANDSTONE.getDefaultState(),Block.Properties.create(Material.ROCK, MaterialColor.WHITE_TERRACOTTA).hardnessAndResistance(0.8F,0.5F), new Item.Properties().group(WNTabs.ROCK_BUILDING), WN.RegistryEvents.location("smooth_white_sandstone_stairs")),
                WNBlocks.CUT_WHITE_SANDSTONE = new BlockBase(Block.Properties.create(Material.ROCK, MaterialColor.WHITE_TERRACOTTA).hardnessAndResistance(0.8F,0.5F), new Item.Properties().group(WNTabs.ROCK_BUILDING), WN.RegistryEvents.location("cut_white_sandstone")),
                WNBlocks.CUT_WHITE_SANDSTONE_SLAB = new SlabBase(Block.Properties.create(Material.ROCK, MaterialColor.WHITE_TERRACOTTA).hardnessAndResistance(0.8F,0.5F), new Item.Properties().group(WNTabs.ROCK_BUILDING), WN.RegistryEvents.location("cut_white_sandstone_slab")),
                WNBlocks.CHISELED_WHITE_SANDSTONE = new BlockBase(Block.Properties.create(Material.ROCK, MaterialColor.WHITE_TERRACOTTA).hardnessAndResistance(0.8F,0.5F), new Item.Properties().group(WNTabs.ROCK_BUILDING), WN.RegistryEvents.location("chiseled_white_sandstone")),
                WNBlocks.WHITE_SANDSTONE_BRICKS = new BlockBase(Block.Properties.create(Material.ROCK, MaterialColor.SAND).hardnessAndResistance(1.5F, 6.0F), new Item.Properties().group(WNTabs.ROCK_BUILDING), WN.RegistryEvents.location("white_sandstone_bricks")),
                WNBlocks.WHITE_SANDSTONE_ANCIENT_BRICKS = new BlockBase(Block.Properties.create(Material.ROCK, MaterialColor.SAND).hardnessAndResistance(0.8F), new Item.Properties().group(WNTabs.ROCK_BUILDING), WN.RegistryEvents.location("white_sandstone_ancient_bricks")),


                WNBlocks.CANVAS = new BlockBase(Block.Properties.create(Material.WOOL, MaterialColor.WOOL).hardnessAndResistance(0.4F,0.1F), new Item.Properties().group(WNTabs.WOOD_BUILDING), WN.RegistryEvents.location("canvas"))
