...
public class ItemRegistry {
    ...
    public ItemRegistry(){
        items = new Item[]{
                ...
                //XMAS
                WNItems.GIFT_1 = new GiftItem(new Item.Properties(), GiftItem.GiftColor.CYAN_RED).setRegistryName(location("gift_1")),
                WNItems.GIFT_2 = new GiftItem(new Item.Properties(), GiftItem.GiftColor.RED_YELLOW).setRegistryName(location("gift_2")),
                WNItems.GIFT_3 = new GiftItem(new Item.Properties(), GiftItem.GiftColor.BLUE_PINK).setRegistryName(location("gift_3")),
                WNItems.XMAS_PAPER_1 = new WrappingPaperItem(new Item.Properties(), GiftItem.GiftColor.CYAN_RED).setRegistryName(location("xmas_paper_1")),
                WNItems.XMAS_PAPER_2 = new WrappingPaperItem(new Item.Properties(), GiftItem.GiftColor.RED_YELLOW).setRegistryName(location("xmas_paper_2")),
                WNItems.XMAS_PAPER_3 = new WrappingPaperItem(new Item.Properties(), GiftItem.GiftColor.BLUE_PINK).setRegistryName(location("xmas_paper_3")),
