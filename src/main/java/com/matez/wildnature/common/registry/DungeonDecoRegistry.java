...
public class DungeonDecoRegistry {
    ...
    public static final RegistryObject<Item> stone_bricks_baseblock_item = ITEMS.register("stone_bricks_baseblock", () -> new BlockItem(stone_bricks_baseblock.get(), new Item.Properties()));
    ...
    public static final RegistryObject<Item> stone_bricks_machicolations_item = ITEMS.register("stone_bricks_machicolations", () -> new BlockItem(stone_bricks_machicolations.get(), new Item.Properties()));
    ...
    public static final RegistryObject<Item> stone_bricks_arrowslit_item = ITEMS.register("stone_bricks_arrowslit", () -> new BlockItem(stone_bricks_arrowslit.get(), new Item.Properties()));
    ...
    public static final RegistryObject<Item> stone_bricks_pillar_item = ITEMS.register("stone_bricks_pillar", () -> new WallOrFloorItem(stone_bricks_pillar.get(), stone_bricks_pillar_facing.get(), (new Item.Properties())));
    ...
    public static final RegistryObject<Item> stone_bricks_thin_pillar_item = ITEMS.register("stone_bricks_thin_pillar", () -> new WallOrFloorItem(stone_bricks_thin_pillar.get(), stone_bricks_thin_pillar_facing.get(), (new Item.Properties())));
