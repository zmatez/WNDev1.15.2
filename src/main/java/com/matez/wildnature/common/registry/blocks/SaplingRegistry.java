...
public class SaplingRegistry {
    ...
    public SaplingRegistry(){
        ...
        saplings = new Block[]{
                WNBlocks.APPLE_SAPLING = new SaplingBase(appleTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(), new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("apple_sapling")),
                WNBlocks.PARADISE_APPLE_SAPLING = new SaplingBase(paradiseAppleTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(), new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("paradise_apple_sapling")),
                WNBlocks.ASPEN_SAPLING = new SaplingBase(aspenTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(), new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("aspen_sapling")),
                WNBlocks.BAOBAB_SAPLING = new SaplingBase(baobabTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("baobab_sapling")),
                WNBlocks.BEECH_SAPLING = new SaplingBase(beechTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("beech_sapling")),
                WNBlocks.PURPLE_BEECH_SAPLING = new SaplingBase(purpleBeechTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("purple_beech_sapling")),
                WNBlocks.CEDAR_SAPLING = new SaplingBase(cedarTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("cedar_sapling")),
                WNBlocks.CHERRY_SAPLING = new SaplingBase(cherryTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("cherry_sapling")),
                WNBlocks.CHERRY_PINK_SAPLING = new SaplingBase(cherryPinkTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("cherry_pink_sapling")),
                WNBlocks.CHERRY_WHITE_SAPLING = new SaplingBase(cherryWhiteTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("cherry_white_sapling")),
                WNBlocks.EBONY_SAPLING = new SaplingBase(ebonyTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("ebony_sapling")),
                WNBlocks.EUCALYPTUS_SAPLING = new SaplingBase(eucalyptusTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("eucalyptus_sapling")),
                WNBlocks.FIR_SAPLING = new SaplingBase(firTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("fir_sapling")),
                WNBlocks.FIR_SILVER_SAPLING = new SaplingBase(firSilverTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("fir_silver_sapling")),
                WNBlocks.HAZEL_SAPLING = new SaplingBase(hazelTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("hazel_sapling")),
                WNBlocks.HORNBEAM_SAPLING = new SaplingBase(hornbeamTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("hornbeam_sapling")),
                WNBlocks.JACARANDA_SAPLING = new SaplingBase(jacarandaTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("jacaranda_sapling")),
                WNBlocks.LARCH_SAPLING = new SaplingBase(larchTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(), new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("larch_sapling")),
                WNBlocks.MAHOGANY_SAPLING = new SaplingBase(mahoganyTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("mahogany_sapling")),
                WNBlocks.MANGROVE_SAPLING = new SaplingBase(mangroveTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(), new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("mangrove_sapling")),
                WNBlocks.MAPLE_SAPLING = new SaplingBase(mapleTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(), new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("maple_sapling")),
                WNBlocks.MAPLE_RED_SAPLING = new SaplingBase(mapleRedTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(), new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("maple_red_sapling")),
                WNBlocks.MAPLE_ORANGE_SAPLING = new SaplingBase(mapleOrangeTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(), new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("maple_orange_sapling")),
                WNBlocks.MAPLE_YELLOW_SAPLING = new SaplingBase(mapleYellowTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(), new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("maple_yellow_sapling")),
                WNBlocks.MAPLE_BROWN_SAPLING = new SaplingBase(mapleBrownTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(), new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("maple_brown_sapling")),
                WNBlocks.PALM_SAPLING = new SaplingBase(palmTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("palm_sapling")),
                WNBlocks.PEAR_SAPLING = new SaplingBase(pearTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("pear_sapling")),
                WNBlocks.PINE_SAPLING = new SaplingBase(pineTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("pine_sapling")),
                WNBlocks.PLUM_SAPLING = new SaplingBase(plumTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(), new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("plum_sapling")),
                WNBlocks.MIRABELLE_PLUM_SAPLING = new SaplingBase(mirabellePlumTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(), new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("mirabelle_plum_sapling")),
                WNBlocks.POPLAR_SAPLING = new SaplingBase(poplarTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(), new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("poplar_sapling")),
                WNBlocks.REDWOOD_SAPLING = new SaplingBase(redwoodTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("redwood_sapling")),
                WNBlocks.ROWAN_SAPLING_RED = new SaplingBase(rowanTreesRed, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("rowan_sapling_red")),
                WNBlocks.ROWAN_SAPLING_ORANGE = new SaplingBase(rowanTreesOrange, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("rowan_sapling_orange")),
                WNBlocks.WILLOW_SAPLING = new SaplingBase(willowTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("willow_sapling")),
                WNBlocks.LEMON_SAPLING = new SaplingBase(lemonTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("lemon_sapling")),
                WNBlocks.ORANGE_SAPLING = new SaplingBase(orangeTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("orange_sapling")),
                WNBlocks.GRAPE_FRUIT_SAPLING = new SaplingBase(grapefruitTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("grape_fruit_sapling")),
                WNBlocks.BANANA_SAPLING = new SaplingBase(bananaTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("banana_sapling")),
                WNBlocks.LIME_SAPLING = new SaplingBase(limeTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("lime_sapling")),
                WNBlocks.OLIVE_SAPLING = new SaplingBase(oliveTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("olive_sapling")),
                WNBlocks.PEACH_SAPLING = new SaplingBase(peachTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("peach_sapling")),
                WNBlocks.POMEGRANATE_SAPLING = new SaplingBase(pomegranateTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("pomegranate_sapling")),
                WNBlocks.MANGO_SAPLING = new SaplingBase(mangoTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("mango_sapling")),
                WNBlocks.NUYTSIA_SAPLING = new SaplingBase(nuytsiaTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("nuytsia_sapling")),
                WNBlocks.MAGNOLIA_SAPLING = new SaplingBase(magnoliaTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("magnolia_sapling")),
                WNBlocks.FORSYTHIA_SAPLING = new SaplingBase(forsythiaTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), Main.RegistryEvents.location("forsythia_sapling"))
