...
import com.matez.wildnature.world.generation.structures.nature.woods.cedar.*;
...
import com.matez.wildnature.world.generation.structures.nature.woods.deco.*;
...
import com.matez.wildnature.world.generation.structures.nature.woods.mangrove.*;
...
import com.matez.wildnature.world.generation.structures.nature.woods.orchard.*;
...
import com.matez.wildnature.world.generation.structures.nature.woods.sequoia.*;
import com.matez.wildnature.world.generation.structures.nature.woods.spruce.*;
import com.matez.wildnature.world.generation.structures.nature.woods.willow.*;
...
public class SaplingRegistry {
    ...
    public SaplingRegistry(){
        ...
        weighList.add(new aspen1(),10);
        weighList.add(new aspen2(),10);
        weighList.add(new aspen3(),10);
        weighList.add(new aspen4(),10);
        weighList.add(new aspen5(),10);
        ...
        //CITRUS
        weighList = new TreeWeighList();
        weighList.add(new lemon1(),10);
        weighList.add(new lemon2(),10);
        weighList.add(new lemon3(),10);
        SchemTree lemonTrees= new SchemTree(weighList);

        weighList = new TreeWeighList();
        weighList.add(new orange1(),10);
        weighList.add(new orange2(),10);
        weighList.add(new orange3(),10);
        SchemTree orangeTrees= new SchemTree(weighList);

        weighList = new TreeWeighList();
        weighList.add(new grapefruit1(),10);
        weighList.add(new grapefruit2(),10);
        weighList.add(new grapefruit3(),10);
        ...
        weighList = new TreeWeighList();
        weighList.add(new lime1(),10);
        weighList.add(new lime2(),10);
        weighList.add(new lime3(),10);
        ...
        weighList = new TreeWeighList();
        weighList.add(new peach1(),10);
        weighList.add(new peach2(),10);
        weighList.add(new peach3(),10);
        SchemTree peachTrees= new SchemTree(weighList);

        weighList = new TreeWeighList();
        weighList.add(new pomegranate1(),10);
        weighList.add(new pomegranate2(),10);
        weighList.add(new pomegranate3(),10);
        SchemTree pomegranateTrees= new SchemTree(weighList);

        weighList = new TreeWeighList();
        weighList.add(new mango1(),10);
        weighList.add(new mango2(),10);
        weighList.add(new mango3(),10);
        weighList.add(new mango_big1(),3);
        weighList.add(new mango_big2(),3);
        weighList.add(new mango_big3(),3);
        ...
        weighList = new TreeWeighList();
        weighList.add(new sequoia1().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_GREEN_LEAVES)),10);
        weighList.add(new sequoia2().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_GREEN_LEAVES)),10);
        weighList.add(new sequoia3().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_GREEN_LEAVES)),10);
        weighList.add(new sequoia4().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_GREEN_LEAVES)),10);
        weighList.add(new sequoia5().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_GREEN_LEAVES)),10);
        weighList.add(new sequoia6().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_GREEN_LEAVES)),10);
        SchemTree metasequoiaGreenTrees= new SchemTree(weighList);

        weighList = new TreeWeighList();
        weighList.add(new sequoia1().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_RED_LEAVES)),10);
        weighList.add(new sequoia2().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_RED_LEAVES)),10);
        weighList.add(new sequoia3().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_RED_LEAVES)),10);
        weighList.add(new sequoia4().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_RED_LEAVES)),10);
        weighList.add(new sequoia5().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_RED_LEAVES)),10);
        weighList.add(new sequoia6().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_RED_LEAVES)),10);
        SchemTree metasequoiaRedTrees= new SchemTree(weighList);

        weighList = new TreeWeighList();
        weighList.add(new sequoia1().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_ORANGE_LEAVES)),10);
        weighList.add(new sequoia2().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_ORANGE_LEAVES)),10);
        weighList.add(new sequoia3().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_ORANGE_LEAVES)),10);
        weighList.add(new sequoia4().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_ORANGE_LEAVES)),10);
        weighList.add(new sequoia5().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_ORANGE_LEAVES)),10);
        weighList.add(new sequoia6().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_ORANGE_LEAVES)),10);
        SchemTree metasequoiaOrangeTrees= new SchemTree(weighList);

        weighList = new TreeWeighList();
        weighList.add(new sequoia1().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_YELLOW_LEAVES)),10);
        weighList.add(new sequoia2().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_YELLOW_LEAVES)),10);
        weighList.add(new sequoia3().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_YELLOW_LEAVES)),10);
        weighList.add(new sequoia4().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_YELLOW_LEAVES)),10);
        weighList.add(new sequoia5().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_YELLOW_LEAVES)),10);
        weighList.add(new sequoia6().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_YELLOW_LEAVES)),10);
        SchemTree metasequoiaYellowTrees= new SchemTree(weighList);

        weighList = new TreeWeighList();
        weighList.add(new sequoia1().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_BROWN_LEAVES)),10);
        weighList.add(new sequoia2().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_BROWN_LEAVES)),10);
        weighList.add(new sequoia3().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_BROWN_LEAVES)),10);
        weighList.add(new sequoia4().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_BROWN_LEAVES)),10);
        weighList.add(new sequoia5().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_BROWN_LEAVES)),10);
        weighList.add(new sequoia6().setCustomLogAndLeaf(WNBlocks.REDWOOD_LOG.getDefaultState(), SchemFeature.notDecayingLeaf(WNBlocks.METASEQUOIA_BROWN_LEAVES)),10);
        SchemTree metasequoiaBrownTrees= new SchemTree(weighList);

        saplings = new Block[]{
                WNBlocks.APPLE_SAPLING = new SaplingBase(appleTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(), new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("apple_sapling")),
                WNBlocks.PARADISE_APPLE_SAPLING = new SaplingBase(paradiseAppleTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(), new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("paradise_apple_sapling")),
                WNBlocks.ASPEN_SAPLING = new SaplingBase(aspenTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(), new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("aspen_sapling")),
                WNBlocks.BAOBAB_SAPLING = new SaplingBase(baobabTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("baobab_sapling")),
                WNBlocks.BEECH_SAPLING = new SaplingBase(beechTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("beech_sapling")),
                WNBlocks.PURPLE_BEECH_SAPLING = new SaplingBase(purpleBeechTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("purple_beech_sapling")),
                WNBlocks.CEDAR_SAPLING = new SaplingBase(cedarTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("cedar_sapling")),
                WNBlocks.CHERRY_SAPLING = new SaplingBase(cherryTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("cherry_sapling")),
                WNBlocks.CHERRY_PINK_SAPLING = new SaplingBase(cherryPinkTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("cherry_pink_sapling")),
                WNBlocks.CHERRY_WHITE_SAPLING = new SaplingBase(cherryWhiteTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("cherry_white_sapling")),
                WNBlocks.EBONY_SAPLING = new SaplingBase(ebonyTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("ebony_sapling")),
                WNBlocks.EUCALYPTUS_SAPLING = new SaplingBase(eucalyptusTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("eucalyptus_sapling")),
                WNBlocks.FIR_SAPLING = new SaplingBase(firTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("fir_sapling")),
                WNBlocks.FIR_SILVER_SAPLING = new SaplingBase(firSilverTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("fir_silver_sapling")),
                WNBlocks.HAZEL_SAPLING = new SaplingBase(hazelTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("hazel_sapling")),
                WNBlocks.HORNBEAM_SAPLING = new SaplingBase(hornbeamTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("hornbeam_sapling")),
                WNBlocks.JACARANDA_SAPLING = new SaplingBase(jacarandaTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("jacaranda_sapling")),
                WNBlocks.LARCH_SAPLING = new SaplingBase(larchTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(), new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("larch_sapling")),
                WNBlocks.MAHOGANY_SAPLING = new SaplingBase(mahoganyTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("mahogany_sapling")),
                WNBlocks.MANGROVE_SAPLING = new SaplingBase(mangroveTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(), new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("mangrove_sapling")),
                WNBlocks.MAPLE_SAPLING = new SaplingBase(mapleTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(), new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("maple_sapling")),
                WNBlocks.MAPLE_RED_SAPLING = new SaplingBase(mapleRedTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(), new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("maple_red_sapling")),
                WNBlocks.MAPLE_ORANGE_SAPLING = new SaplingBase(mapleOrangeTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(), new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("maple_orange_sapling")),
                WNBlocks.MAPLE_YELLOW_SAPLING = new SaplingBase(mapleYellowTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(), new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("maple_yellow_sapling")),
                WNBlocks.MAPLE_BROWN_SAPLING = new SaplingBase(mapleBrownTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(), new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("maple_brown_sapling")),
                WNBlocks.PALM_SAPLING = new SaplingBase(palmTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("palm_sapling")),
                WNBlocks.PEAR_SAPLING = new SaplingBase(pearTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("pear_sapling")),
                WNBlocks.PINE_SAPLING = new SaplingBase(pineTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("pine_sapling")),
                WNBlocks.PLUM_SAPLING = new SaplingBase(plumTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(), new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("plum_sapling")),
                ...
                WNBlocks.GRAPE_FRUIT_SAPLING = new SaplingBase(grapefruitTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("grape_fruit_sapling")),
                WNBlocks.BANANA_SAPLING = new SaplingBase(bananaTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("banana_sapling")),
                WNBlocks.LIME_SAPLING = new SaplingBase(limeTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("lime_sapling")),
                WNBlocks.OLIVE_SAPLING = new SaplingBase(oliveTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("olive_sapling")),
                WNBlocks.PEACH_SAPLING = new SaplingBase(peachTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("peach_sapling")),
                WNBlocks.POMEGRANATE_SAPLING = new SaplingBase(pomegranateTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("pomegranate_sapling")),
                WNBlocks.MANGO_SAPLING = new SaplingBase(mangoTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("mango_sapling")),
                WNBlocks.NUYTSIA_SAPLING = new SaplingBase(nuytsiaTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("nuytsia_sapling")),
                WNBlocks.MAGNOLIA_SAPLING = new SaplingBase(magnoliaTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("magnolia_sapling")),
                WNBlocks.FORSYTHIA_SAPLING = new SaplingBase(forsythiaTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("forsythia_sapling")),
                WNBlocks.METASEQUOIA_GREEN_SAPLING = new SaplingBase(metasequoiaGreenTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("metasequoia_green_sapling")),
                WNBlocks.METASEQUOIA_RED_SAPLING = new SaplingBase(metasequoiaRedTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("metasequoia_red_sapling")),
                WNBlocks.METASEQUOIA_ORANGE_SAPLING = new SaplingBase(metasequoiaOrangeTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("metasequoia_orange_sapling")),
                WNBlocks.METASEQUOIA_YELLOW_SAPLING = new SaplingBase(metasequoiaYellowTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("metasequoia_yellow_sapling")),
                WNBlocks.METASEQUOIA_BROWN_SAPLING = new SaplingBase(metasequoiaBrownTrees, Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).doesNotBlockMovement(),new Item.Properties().group(WNTabs.SURFACE_PLANTS), WN.RegistryEvents.location("metasequoia_brown_sapling")),
