...
public class GemRegistry {
    ...
    public GemRegistry(){
        item = new Item[]{
                //DECO GEMS
                WNItems.AMBER_INGOT = new Item(new Item.Properties().group(Main.WILDNATURE_UNDERGROUND_GROUP)).setRegistryName(Main.RegistryEvents.location("amber_ingot")),

                //TOOLS
                WNItems.TIN_RAW = new Item(new Item.Properties().group(Main.WILDNATURE_UNDERGROUND_GROUP)).setRegistryName(Main.RegistryEvents.location("tin_raw")),
                ...
                WNItems.STEEL_SWORD = new SwordItem(WNItemTier.STEEL, 3, -2F, (new Item.Properties()).group(ItemGroup.COMBAT)).setRegistryName(Main.RegistryEvents.location("steel_sword")),
                WNItems.STEEL_PICKAXE = new PickaxeItem(WNItemTier.STEEL, 1, -2.8F, (new Item.Properties()).group(ItemGroup.TOOLS)).setRegistryName(Main.RegistryEvents.location("steel_pickaxe")),
                WNItems.STEEL_AXE = new AxeItem(WNItemTier.STEEL, 5, -3F, (new Item.Properties()).group(ItemGroup.TOOLS)).setRegistryName(Main.RegistryEvents.location("steel_axe")),
                WNItems.STEEL_SHOVEL = new ShovelItem(WNItemTier.STEEL, 1.5F, -3F, (new Item.Properties()).group(ItemGroup.TOOLS)).setRegistryName(Main.RegistryEvents.location("steel_shovel")),
                WNItems.STEEL_HOE = new HoeItem(WNItemTier.STEEL,  0F, (new Item.Properties()).group(ItemGroup.TOOLS)).setRegistryName(Main.RegistryEvents.location("steel_hoe")),
                ...
                WNItems.SAPPHIRE_RAW = new Item(new Item.Properties().group(Main.WILDNATURE_UNDERGROUND_GROUP)).setRegistryName(Main.RegistryEvents.location("sapphire_raw")),
                WNItems.SAPPHIRE_INGOT = new Item(new Item.Properties().group(Main.WILDNATURE_UNDERGROUND_GROUP)).setRegistryName(Main.RegistryEvents.location("sapphire_ingot")),
                ...
                WNItems.RUBY_RAW = new Item(new Item.Properties().group(Main.WILDNATURE_UNDERGROUND_GROUP)).setRegistryName(Main.RegistryEvents.location("ruby_raw")),
                WNItems.RUBY_INGOT = new Item(new Item.Properties().group(Main.WILDNATURE_UNDERGROUND_GROUP)).setRegistryName(Main.RegistryEvents.location("ruby_ingot")),
                ...
                WNItems.MALACHITE_RAW = new Item(new Item.Properties().group(Main.WILDNATURE_UNDERGROUND_GROUP)).setRegistryName(Main.RegistryEvents.location("malachite_raw")),
                WNItems.MALACHITE_INGOT = new Item(new Item.Properties().group(Main.WILDNATURE_UNDERGROUND_GROUP)).setRegistryName(Main.RegistryEvents.location("malachite_ingot")),
                ...
                WNItems.AMETHYST_INGOT = new Item(new Item.Properties().group(Main.WILDNATURE_UNDERGROUND_GROUP)).setRegistryName(Main.RegistryEvents.location("amethyst_ingot")),
