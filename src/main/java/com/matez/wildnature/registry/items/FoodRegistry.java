...
import static com.matez.wildnature.Main.WILDNATURE_GROUP;
...
public class FoodRegistry {
    ...
    public FoodRegistry(){
        items = new Item[]{
                ...
                WNItems.COFFEE_LEAVES = new Item(new Item.Properties().group(WILDNATURE_GROUP)).setRegistryName(location("coffee_leaves")),
                WNItems.COFFEE_BRANCH = new Item(new Item.Properties().group(WILDNATURE_GROUP)).setRegistryName(location("coffee_branch")),
                WNItems.COFFEE_BERRY_GREEN = new Item(new Item.Properties().group(WILDNATURE_GROUP)).setRegistryName(location("coffee_berry_green")),
                WNItems.COFFEE_BERRY = new Item(new Item.Properties().group(WILDNATURE_GROUP)).setRegistryName(location("coffee_berry")),
                WNItems.COFFEE_BEAN = new Item(new Item.Properties().group(WILDNATURE_GROUP)).setRegistryName(location("coffee_bean")),
