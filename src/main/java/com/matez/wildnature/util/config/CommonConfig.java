...
public class CommonConfig {
    ...
    public static ForgeConfigSpec.IntValue tinOreHarvestLevel, copperOreHarvestLevel, amethystFormationHarvestLevel, sapphireFormationHarvestLevel, malachiteFormationHarvestLevel, silverOreHarvestLevel, amberOreHarvestLevel, rubyFormationHarvestLevel;
    ...
    public static ForgeConfigSpec.BooleanValue generateSeaCaverns;
    ...
    private void generator() {
        ...
        generatorThreads = builder
                ...
                .defineInRange("generatorThreads", 16, 1, 16);
    ...
    private void structure() {
        ...
        generateSeaCaverns = builder
                .comment("Sea Cavern structure\nDefault: true")
                .define("ambient.seaCaverns", true);
