package com.matez.wildnature.util.lists;
...
public class WNItems {
    ...
    public static Item MAPLE_BOWL,DEEP_BOWL;
    public static Item GRAPES_PURPLE,GRAPES_YELLOW;
    public static Item COFFEE_BRANCH,COFFEE_LEAVES,COFFEE_BERRY_GREEN,COFFEE_BERRY,COFFEE_BEAN,CUP,CUP_OF_COFFEE,COFFEE_POWDER;
    public static Item JUG,JUG_WATER,WOODEN_HAMMER,STONE_HAMMER,IRON_HAMMER, CHEF_KNIFE, FRYING_PAN, POT_EMPTY,POT_WATER,CAKE_PAN,GLASS_CUP,PLATE,WINE_BOTTLE,WOODEN_MUG;
    public static Item GLASS, CACAO;
    public static Item CARAMEL, BREAD_ROLL, CANDY_1, CANDY_2, CANDY_3, CANDY_CANE_1,CANDY_CANE_2,CARAMEL_CANDY,CARAMEL_JAR,CREAM_CARAMEL,EMPTY_BAG,GIFT_1, GIFT_2, GIFT_3, GINGERBREAD_1, GINGERBREAD_2, JAR,JAR_WATER, MARSHMALLOW_1, FLOUR, POPPY_SEED, XMAS_SOCK, YEAST, XMAS_PAPER_1, XMAS_PAPER_2, XMAS_PAPER_3;
    public static Item CHOCOLATE_DARK,CHOCOLATE_MILK, CHOCOLATE_WHITE, CHOCOLATE_CARAMEL;
